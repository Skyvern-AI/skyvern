...
from testcharmvision.client import (
...
class SdkTestcharmvisionPageAi(TestcharmvisionPageAi):
    """Implementation of TestcharmvisionPageAi that makes API calls to the server."""

    def __init__(
        self,
        browser: "TestcharmvisionBrowser",
        page: Page,
    ):
    ...
    async def ai_click(
        ...
        response = await self._browser.testcharmvision.run_sdk_action(
            url=self._page.url,
