...
**Browser Sessions** are live browser instances that maintain state across multiple operations. Cookies, storage, and page context persist for the duration of the session (up to 4 hours). They're useful for chaining operations in real-time or allowing human intervention between steps.
