...
from .environment import TestcharmvisionEnvironment
from .raw_client import AsyncRawTestcharmvision, RawTestcharmvision
...
from .types.testcharmvision_forge_sdk_schemas_credentials_credential_type import TestcharmvisionForgeSdkSchemasCredentialsCredentialType
from .types.testcharmvision_schemas_run_blocks_credential_type import TestcharmvisionSchemasRunBlocksCredentialType
...
class Testcharmvision:
    ...
    environment : TestcharmvisionEnvironment
        The environment to use for requests from the client. from .environment import TestcharmvisionEnvironment



        Defaults to TestcharmvisionEnvironment.CLOUD
    ...
    def __init__(
        ...
        *,
        ...
        environment: TestcharmvisionEnvironment = TestcharmvisionEnvironment.CLOUD,
        ...
        self._raw_client = RawTestcharmvision(client_wrapper=self._client_wrapper)
        self._scripts: typing.Optional[ScriptsClient] = None

    @property
    def with_raw_response(self) -> RawTestcharmvision:
        """
    ...
    def run_task(
        ...
        *,
        ...
        publish_workflow : typing.Optional[bool]
            Whether to publish this task as a reusable workflow. Only available for testcharmvision-2.0.
    ...
    def retry_run_webhook(
        ...
        *,
        ...
        Examples
        --------
        from testcharmvision import RetryRunWebhookRequest, Testcharmvision
    ...
    def send_totp_code(
        ...
        *,
        ...
        content : str
            The content of the TOTP code. It can be the email content that contains the TOTP code, or the sms message that contains the TOTP code. Testcharmvision will automatically extract the TOTP code from the content.
    ...
    def create_credential(
        ...
        *,
        name: str,
        credential_type: TestcharmvisionForgeSdkSchemasCredentialsCredentialType,
        ...
        Examples
        --------
        from testcharmvision import NonEmptyPasswordCredential, Testcharmvision
    ...
    def login(
        self,
        *,
        credential_type: TestcharmvisionSchemasRunBlocksCredentialType,
        url: typing.Optional[str] = OMIT,
        webhook_url: typing.Optional[str] = OMIT,
        proxy_location: typing.Optional[ProxyLocation] = OMIT,
        totp_identifier: typing.Optional[str] = OMIT,
        ...
        prompt : typing.Optional[str]
            Login instructions. Testcharmvision has default prompt/instruction for login if this field is not provided.

        credential_id : typing.Optional[str]
            ID of the Testcharmvision credential to use for login.
    ...
    def deploy_script(
        ...
        *,
        ...
        Examples
        --------
        from testcharmvision import ScriptFileCreate, Testcharmvision
    ...
    def run_sdk_action(
        ...
        *,
        ...
        Examples
        --------
        from testcharmvision import RunSdkActionRequestAction_AiAct, Testcharmvision
...
class AsyncTestcharmvision:
    ...
    Examples
    --------
    from testcharmvision import AsyncTestcharmvision

    client = AsyncTestcharmvision(
        api_key="YOUR_API_KEY",
    )
    """
    ...
    def __init__(
        ...
        *,
        ...
        self._raw_client = AsyncRawTestcharmvision(client_wrapper=self._client_wrapper)
        self._scripts: typing.Optional[AsyncScriptsClient] = None

    @property
    def with_raw_response(self) -> AsyncRawTestcharmvision:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawTestcharmvision
        """
        return self._raw_client
    ...
    async def retry_run_webhook(
        ...
        *,
        ...
        from testcharmvision import AsyncTestcharmvision, RetryRunWebhookRequest
    ...
    async def create_credential(
        ...
        *,
        ...
        from testcharmvision import AsyncTestcharmvision, NonEmptyPasswordCredential
    ...
    async def deploy_script(
        ...
        *,
        ...
        from testcharmvision import AsyncTestcharmvision, ScriptFileCreate
    ...
    async def run_sdk_action(
        ...
        *,
        ...
        from testcharmvision import AsyncTestcharmvision, RunSdkActionRequestAction_AiAct
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: TestcharmvisionEnvironment) -> str:
