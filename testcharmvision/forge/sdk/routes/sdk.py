...
from testcharmvision.core.script_generations.real_testcharmvision_page_ai import RealTestcharmvisionPageAi
from testcharmvision.core.script_generations.script_testcharmvision_page import ScriptTestcharmvisionPage
from testcharmvision.exceptions import ScrapingFailed
from testcharmvision.forge import app
from testcharmvision.forge.sdk.api.files import validate_download_url
...
from testcharmvision.forge.sdk.schemas.sdk_actions import (
    RunSdkActionRequest,
    RunSdkActionResponse,
)
from testcharmvision.forge.sdk.schemas.tasks import TaskStatus
...
from testcharmvision.schemas.workflows import BlockType, WorkflowStatus
...
async def run_sdk_action(
    ...
    try:
        scraped_page = await ScriptTestcharmvisionPage.create_scraped_page(browser_session_id=browser_session_id)
        page = await scraped_page._browser_state.must_get_working_page()
        page_ai = RealTestcharmvisionPageAi(scraped_page, page)
