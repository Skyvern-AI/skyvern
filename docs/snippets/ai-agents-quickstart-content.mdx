...
3. Runs a browser automation that launches a cloud browser, runs AI actions on pages, and prints the result
...
- Always wrap browser usage in try/finally with browser.close().`}</ApiKeyPrompt>
