...
exports.TaskRunResponse = void 0;
...
const TaskRunRequest_js_1 = require("./TaskRunRequest.js");
const TaskRunResponseOutput_js_1 = require("./TaskRunResponseOutput.js");
exports.TaskRunResponse = core.serialization.object({
    runId: core.serialization.property("run_id", core.serialization.string()),
    status: RunStatus_js_1.RunStatus,
    output: TaskRunResponseOutput_js_1.TaskRunResponseOutput.optional(),
    ...
    errors: core.serialization
        ...
        .optional(),
    runRequest: core.serialization.property("run_request", TaskRunRequest_js_1.TaskRunRequest.optional()),
});
