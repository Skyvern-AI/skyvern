...
If you're writing automations in code instead, the equivalent operations are Page and Agent methods. See the [Actions Reference](/multi-step-automations/actions-reference) for the code-first counterparts to these blocks.
