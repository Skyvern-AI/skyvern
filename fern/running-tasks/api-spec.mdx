...
| engine | String | no | "skyvern-1.0" | The Skyvern engine version to use for this task. Supported values are "skyvern-1.0" and "skyvern-2.0". Default is "skyvern-1.0" |
...
| publish_workflow | Boolean | no | false | Deprecated. Publish an explicitly requested V2 task as a reusable workflow. Default is false |
