...
class EmailInboxBlockParametersItem_AwsSecret(UniversalBaseModel):
...
class EmailInboxBlockParametersItem_AzureSecret(UniversalBaseModel):
...
class EmailInboxBlockParametersItem_AzureVaultCredential(UniversalBaseModel):
...
class EmailInboxBlockParametersItem_BitwardenCreditCardData(UniversalBaseModel):
...
class EmailInboxBlockParametersItem_BitwardenLoginCredential(UniversalBaseModel):
...
class EmailInboxBlockParametersItem_BitwardenSensitiveInformation(UniversalBaseModel):
...
class EmailInboxBlockParametersItem_Context(UniversalBaseModel):
...
class EmailInboxBlockParametersItem_Credential(UniversalBaseModel):
...
class EmailInboxBlockParametersItem_Onepassword(UniversalBaseModel):
...
class EmailInboxBlockParametersItem_Output(UniversalBaseModel):
...
class EmailInboxBlockParametersItem_Workflow(UniversalBaseModel):
...
EmailInboxBlockParametersItem = typing.Union[
...
update_forward_refs(EmailInboxBlockParametersItem_Context)
