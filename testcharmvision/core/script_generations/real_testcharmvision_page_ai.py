...
from testcharmvision.constants import TESTCHARMVISION_PAGE_MAX_SCRAPING_RETRIES, SPECIAL_FIELD_VERIFICATION_CODE
...
from testcharmvision.schemas.workflows import BlockStatus
...
from testcharmvision.webeye.actions.parse_actions import parse_actions
...
class RealTestcharmvisionPageAi(TestcharmvisionPageAi):
    def __init__(
        self,
    ...
    async def _refresh_scraped_page(
        self, take_screenshots: bool = True, max_retries: int = TESTCHARMVISION_PAGE_MAX_SCRAPING_RETRIES
    ) -> None:
    ...
    async def ai_locate_element(
        ...
        locate_element_prompt = load_prompt_with_elements(
            ...
            html_need_testcharmvision_attrs=True,
        ...
        xpath: str | None = None
        if element_id:
            testcharmvision_element_data = scraped_page_refreshed.id_to_element_dict.get(element_id)
            if testcharmvision_element_data and "xpath" in testcharmvision_element_data:
                xpath = testcharmvision_element_data.get("xpath")
