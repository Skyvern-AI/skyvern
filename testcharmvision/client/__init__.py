...
if typing.TYPE_CHECKING:
    ...
    from . import scripts
    from .client import AsyncTestcharmvision, Testcharmvision
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "Testcharmvision": ".client",
    "TestcharmvisionEnvironment": ".environment",
    "TestcharmvisionForgeSdkSchemasCredentialsCredentialType": ".types",
    "TestcharmvisionSchemasRunBlocksCredentialType": ".types",
    "TaskBlock": ".types",
