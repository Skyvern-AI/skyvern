...
|---------|-------------|
| **Timeout** | How long the session stays open, in minutes. Min: 5; max: 240 (4 hours) — requests above 240 are rejected. Longer durations are available on the enterprise plan (contact sales@skyvern.com). Default: 60. |
