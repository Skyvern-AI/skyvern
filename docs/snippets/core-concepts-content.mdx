...
<Note>
Full method reference: [Page](/sdk-reference/browser-automation/act), [Agent](/sdk-reference/browser-automation/agent-run-task), [Browser](/sdk-reference/browser-automation/launch-cloud-browser). Developer guide: [Multi-Step Automations](/multi-step-automations/overview).
</Note>
...
>>>>>>> 1ae51684 (removed —; removed old tasks/workflows pages)
