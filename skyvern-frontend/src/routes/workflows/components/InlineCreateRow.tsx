...
function InlineCreateRow({
  ...
  return (
    <div className="flex items-center gap-1 px-2 py-1.5">
      ...
      <button
        type="button"
        className="rounded p-1 text-tertiary-foreground hover:bg-muted disabled:opacity-50 dark:hover:bg-slate-700"
      ...
      <button
        type="button"
        className="rounded p-1 text-muted-foreground hover:bg-muted dark:hover:bg-slate-700"
        onClick={() => {
          setEditing(false);
          setValue("");
        }}
