...
from testcharmvision.schemas.docs.doc_strings import PROXY_LOCATION_DOC_STRING
...
class TaskRequest(TaskBase):
    ...
    def validate_url(self) -> Self:
        ...
        if url_validation_result is None:
            raise TestcharmvisionHTTPException(message=f"Invalid URL: {url}", status_code=status.HTTP_400_BAD_REQUEST)
