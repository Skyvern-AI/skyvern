...
export declare const ValidationBlockParametersItem: core.serialization.Schema<serializers.ValidationBlockParametersItem.Raw, Skyvern.ValidationBlockParametersItem>;
export declare namespace ValidationBlockParametersItem {
    type Raw = ValidationBlockParametersItem.AwsSecret | ValidationBlockParametersItem.AzureSecret | ValidationBlockParametersItem.AzureVaultCredential | ValidationBlockParametersItem.BitwardenCreditCardData | ValidationBlockParametersItem.BitwardenLoginCredential | ValidationBlockParametersItem.BitwardenSensitiveInformation | ValidationBlockParametersItem.Context | ValidationBlockParametersItem.Credential | ValidationBlockParametersItem.Onepassword | ValidationBlockParametersItem.Output | ValidationBlockParametersItem.Workflow;
