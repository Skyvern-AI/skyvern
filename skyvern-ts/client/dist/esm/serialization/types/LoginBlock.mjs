...
export const LoginBlock = core.serialization.object({
    ...
    dataSchema: core.serialization.property("data_schema", LoginBlockDataSchema.optional()),
    ...
    parameters: core.serialization.list(LoginBlockParametersItem).optional(),
