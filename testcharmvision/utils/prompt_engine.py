...
from testcharmvision.constants import DEFAULT_MAX_TOKENS
from testcharmvision.errors.errors import UserDefinedError
from testcharmvision.forge.sdk.prompting import PromptEngine
from testcharmvision.utils.token_counter import count_tokens
from testcharmvision.webeye.scraper.scraped_page import ElementTreeBuilder
...
def load_prompt_with_elements(
    ...
    template_name: str,
    html_need_testcharmvision_attrs: bool = True,
    **kwargs: Any,
) -> str:
    elements = element_tree_builder.build_element_tree(html_need_testcharmvision_attrs=html_need_testcharmvision_attrs)
    ...
    if token_count > DEFAULT_MAX_TOKENS and element_tree_builder.support_economy_elements_tree():
        ...
        economy_elements_tree = element_tree_builder.build_economy_elements_tree(
            html_need_testcharmvision_attrs=html_need_testcharmvision_attrs
        )
