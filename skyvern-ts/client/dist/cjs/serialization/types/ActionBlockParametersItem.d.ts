...
export declare const ActionBlockParametersItem: core.serialization.Schema<serializers.ActionBlockParametersItem.Raw, Skyvern.ActionBlockParametersItem>;
export declare namespace ActionBlockParametersItem {
    type Raw = ActionBlockParametersItem.AwsSecret | ActionBlockParametersItem.AzureSecret | ActionBlockParametersItem.AzureVaultCredential | ActionBlockParametersItem.BitwardenCreditCardData | ActionBlockParametersItem.BitwardenLoginCredential | ActionBlockParametersItem.BitwardenSensitiveInformation | ActionBlockParametersItem.Context | ActionBlockParametersItem.Credential | ActionBlockParametersItem.Onepassword | ActionBlockParametersItem.Output | ActionBlockParametersItem.Workflow;
