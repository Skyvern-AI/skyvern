...
<img src="/images/cloud/run-wf-1.png" alt="API key display with reveal and copy buttons" />

2. **From the workflows list**: Click the **play icon** on the workflow's row.

<img src="/images/cloud/run-wf-2.png" alt="API key display with reveal and copy buttons" />
...
<img src="/images/cloud/run-wf-3.png" alt="API key display with reveal and copy buttons" />
...
<Frame>
<img src="/images/cloud/run-wf-6.png" alt="API key display with reveal and copy buttons" />
</Frame>
<br/>
<Frame>
<img src="/images/cloud/run-wf-7.png" alt="API key display with reveal and copy buttons" />
</Frame>
---
...
<img src="/images/cloud/run-wf-8.png" alt="API key display with reveal and copy buttons" />
...
<img src="/images/cloud/run-wf-4.png" alt="API key display with reveal and copy buttons" />
2. Go to **Workflows ** button (clock icon) in the workflow editor: shows runs for this specific workflow
<img src="/images/cloud/run-wf-5.png" alt="API key display with reveal and copy buttons" />
