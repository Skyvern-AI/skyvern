                      ...
                      <div className="flex gap-16">
                        <FormLabel>
                          <div className="w-72">
                            ...
                            <h2 className="text-base text-slate-400">
                              Where should Testcharmvision go and what should Testcharmvision
                              do?
                            </h2>
                          </div>
                        </FormLabel>
                        <div className="w-full">
                          <FormControl>
                            <AutoResizingTextarea
                              {...field}
                              placeholder="Tell Testcharmvision what to do."
                          ...
                          <FormLabel>
                            <div className="w-72">
                              ...
                              <h2 className="text-sm text-slate-400">
                                Route Testcharmvision through one of our available
                                proxies.
                              </h2>
                            </div>
                          </FormLabel>
