...
class WorkflowTriggerBlockParametersItem_AwsSecret(UniversalBaseModel):
...
class WorkflowTriggerBlockParametersItem_AzureSecret(UniversalBaseModel):
...
class WorkflowTriggerBlockParametersItem_AzureVaultCredential(UniversalBaseModel):
...
class WorkflowTriggerBlockParametersItem_BitwardenCreditCardData(UniversalBaseModel):
...
class WorkflowTriggerBlockParametersItem_BitwardenLoginCredential(UniversalBaseModel):
...
class WorkflowTriggerBlockParametersItem_BitwardenSensitiveInformation(UniversalBaseModel):
...
class WorkflowTriggerBlockParametersItem_Context(UniversalBaseModel):
...
class WorkflowTriggerBlockParametersItem_Credential(UniversalBaseModel):
...
class WorkflowTriggerBlockParametersItem_Onepassword(UniversalBaseModel):
...
class WorkflowTriggerBlockParametersItem_Output(UniversalBaseModel):
...
class WorkflowTriggerBlockParametersItem_Workflow(UniversalBaseModel):
...
WorkflowTriggerBlockParametersItem = typing.Union[
...
update_forward_refs(WorkflowTriggerBlockParametersItem_Context)
