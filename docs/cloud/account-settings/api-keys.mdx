...
Open **Settings** in the sidebar. The **API Keys** card shows your current key in a masked field. Click the **eye icon** to reveal the full value, or the **copy icon** to copy it to your clipboard.
