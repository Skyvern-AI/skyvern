...
<img src="/images/cloud/run-wf-1.png" alt="Workflows list page with play icon to start a run from the list" />

2. **From the workflows list**: Click the **play icon** on the workflow's row.

<img src="/images/cloud/run-wf-2.png" alt="Workflow editor with the Run button highlighted in the header bar" />
