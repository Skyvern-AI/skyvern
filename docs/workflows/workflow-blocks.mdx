...
- Step 4. Create a FileUploadBlock at the end of your workflow
    ...
    - Input your s3 bucket name and the AWS region of your bucket.    
    - Input your AWS region
