...
```
list_browser_profiles(include_deleted?, managed?) → list[BrowserProfile]
```
...
**BrowserProfile fields:** `browser_profile_id`, `name`, `description`, `is_managed`, `workflow_permanent_id`, `browser_profile_key_digest`, `created_at`
