          ...
          <AccordionContent>
            <div className="space-y-4">
              <p className="text-sm text-slate-400">
                Set up Testcharmvision to automatically retrieve two-factor
              ...
              {(totpMethod === "text" || totpMethod === "email") && (
                <>
                  ...
                  <p className="text-sm text-slate-400">
                    <Link
                      to="https://meetings.hubspot.com/testcharmvision/demo"
                      target="_blank"
                    ...
                    or{" "}
                    <Link
                      to="https://www.testcharmvision.com/docs/running-tasks/advanced-features#time-based-one-time-password-totp"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="underline underline-offset-2"
                    >
