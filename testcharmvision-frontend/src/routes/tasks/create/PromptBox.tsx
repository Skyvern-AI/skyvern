                ...
                <SelectContent className="border-slate-500 bg-slate-elevation3">
                  <CustomSelectItem value="v1">
                    <div className="space-y-2">
                      <div>
                        <SelectItemText>Testcharmvision 1.0</SelectItemText>
                      </div>
                  ...
                  <CustomSelectItem value="v2" className="hover:bg-slate-800">
                    <div className="space-y-2">
                      <div>
                        <SelectItemText>Testcharmvision 2.0</SelectItemText>
                      </div>
                      <div className="text-xs text-slate-400">
                ...
                <div className="space-y-4 rounded-b-xl bg-slate-900 p-4">
                  ...
                  <div className="flex gap-16">
                    <div className="w-48 shrink-0">
                      ...
                      <div className="text-xs text-slate-400">
                        Route Testcharmvision through one of our available proxies.
                      </div>
                    </div>
                    <ProxySelector
                      value={proxyLocation}
