...
<Steps>
  ...
  <Step title="Enable Save browser session">
    ...
    <img src="/images/cloud/credential-save-browser-session-toggle.png" alt="Save browser session toggle enabled with a login URL field and optional context field below it" />
  </Step>
  ...
  <Step title="Confirm the profile was saved">
    ...
    <img src="/images/cloud/credential-saved-profile-badge.png" alt="Credential row on the Credentials page showing a saved-profile badge with the tested site hostname" />
  </Step>
</Steps>
...
<img src="/images/cloud/create-session-with-profile.png" alt="Create Browser Session panel with a browser profile selected from the Browser Profile dropdown" />
