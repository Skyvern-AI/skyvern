...
class SplitPdfBlockParametersItem_AwsSecret(UniversalBaseModel):
...
class SplitPdfBlockParametersItem_AzureSecret(UniversalBaseModel):
...
class SplitPdfBlockParametersItem_AzureVaultCredential(UniversalBaseModel):
...
class SplitPdfBlockParametersItem_BitwardenCreditCardData(UniversalBaseModel):
...
class SplitPdfBlockParametersItem_BitwardenLoginCredential(UniversalBaseModel):
...
class SplitPdfBlockParametersItem_BitwardenSensitiveInformation(UniversalBaseModel):
...
class SplitPdfBlockParametersItem_Context(UniversalBaseModel):
...
class SplitPdfBlockParametersItem_Credential(UniversalBaseModel):
...
class SplitPdfBlockParametersItem_Onepassword(UniversalBaseModel):
...
class SplitPdfBlockParametersItem_Output(UniversalBaseModel):
...
class SplitPdfBlockParametersItem_Workflow(UniversalBaseModel):
...
SplitPdfBlockParametersItem = typing.Union[
...
update_forward_refs(SplitPdfBlockParametersItem_Context)
