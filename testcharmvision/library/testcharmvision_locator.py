...
class TestcharmvisionLocator:
    ...
    def first(self) -> "TestcharmvisionLocator":
        """Get the first matching element."""
        return TestcharmvisionLocator(self._locator.first)

    def last(self) -> "TestcharmvisionLocator":
        """Get the last matching element."""
        return TestcharmvisionLocator(self._locator.last)

    def nth(self, index: int) -> "TestcharmvisionLocator":
        """Get the nth matching element (0-indexed)."""
        return TestcharmvisionLocator(self._locator.nth(index))

    def filter(self, **kwargs: Any) -> "TestcharmvisionLocator":
        """Filter the locator by additional criteria."""
        return TestcharmvisionLocator(self._locator.filter(**kwargs))

    def locator(self, selector: str, **kwargs: Any) -> "TestcharmvisionLocator":
        """Find a descendant element."""
        return TestcharmvisionLocator(self._locator.locator(selector, **kwargs))

    def get_by_label(self, text: str | Pattern[str], **kwargs: Any) -> "TestcharmvisionLocator":
        """Find an input element by its associated label text."""
        return TestcharmvisionLocator(self._locator.get_by_label(text, **kwargs))

    def get_by_text(self, text: str | Pattern[str], **kwargs: Any) -> "TestcharmvisionLocator":
        """Find an element containing the specified text."""
        return TestcharmvisionLocator(self._locator.get_by_text(text, **kwargs))

    def get_by_title(self, text: str | Pattern[str], **kwargs: Any) -> "TestcharmvisionLocator":
        """Find an element by its title attribute."""
        return TestcharmvisionLocator(self._locator.get_by_title(text, **kwargs))

    def get_by_role(self, role: str, **kwargs: Any) -> "TestcharmvisionLocator":
        """Find an element by its ARIA role."""
        return TestcharmvisionLocator(self._locator.get_by_role(role, **kwargs))

    def get_by_placeholder(self, text: str | Pattern[str], **kwargs: Any) -> "TestcharmvisionLocator":
        """Find an input element by its placeholder text."""
        return TestcharmvisionLocator(self._locator.get_by_placeholder(text, **kwargs))

    def get_by_alt_text(self, text: str | Pattern[str], **kwargs: Any) -> "TestcharmvisionLocator":
        """Find an element by its alt text (typically images)."""
        return TestcharmvisionLocator(self._locator.get_by_alt_text(text, **kwargs))

    def get_by_test_id(self, test_id: str) -> "TestcharmvisionLocator":
        """Find an element by its test ID attribute."""
        return TestcharmvisionLocator(self._locator.get_by_test_id(test_id))
