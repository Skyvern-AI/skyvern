...
export const TaskBlock = core.serialization.object({
    ...
    dataSchema: core.serialization.property("data_schema", TaskBlockDataSchema.optional()),
    ...
    parameters: core.serialization.list(TaskBlockParametersItem).optional(),
