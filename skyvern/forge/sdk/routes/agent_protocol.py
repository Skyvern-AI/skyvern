...
async def run_task(
    ...
    if run_request.engine in CUA_ENGINES or run_request.engine == RunEngine.skyvern_v1:
        ...
        return TaskRunResponse(
            ...
            app_url=f"{settings.SKYVERN_APP_URL}/tasks/{task_v1_response.task_id}",
            run_request=TaskRunRequest(
                engine=run_request.engine,
    ...
    if run_request.engine == RunEngine.skyvern_v2:
        ...
        task_v2 = await app.DATABASE.get_task_v2(task_v2_id=task_v2.observer_cruise_id, organization_id=current_org.organization_id)
        return TaskRunResponse(
            ...
            app_url=f"{settings.SKYVERN_APP_URL}/{task_v2.workflow_permanent_id}/{task_v2.workflow_run_id}",
            run_request=TaskRunRequest(
