...
export declare const NavigationBlockParametersItem: core.serialization.Schema<serializers.NavigationBlockParametersItem.Raw, Skyvern.NavigationBlockParametersItem>;
export declare namespace NavigationBlockParametersItem {
    type Raw = NavigationBlockParametersItem.AwsSecret | NavigationBlockParametersItem.AzureSecret | NavigationBlockParametersItem.AzureVaultCredential | NavigationBlockParametersItem.BitwardenCreditCardData | NavigationBlockParametersItem.BitwardenLoginCredential | NavigationBlockParametersItem.BitwardenSensitiveInformation | NavigationBlockParametersItem.Context | NavigationBlockParametersItem.Credential | NavigationBlockParametersItem.Onepassword | NavigationBlockParametersItem.Output | NavigationBlockParametersItem.Workflow;
