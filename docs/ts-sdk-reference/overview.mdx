...
description: Install the Skyvern TypeScript SDK, authenticate with your API key, and start running browser automation tasks and workflows programmatically.
...
|-----------|------|---------|-------------|
| `apiKey` | `string` | — | **Required.** Your Skyvern API key. Get one at [app.skyvern.com/settings](https://app.skyvern.com/settings/). |
