...
const chipTintByActionType: Record<string, string> = {
  goto_url: "bg-sky-500/10 text-sky-300",
  go_back: "bg-sky-500/10 text-sky-300",
  go_forward: "bg-sky-500/10 text-sky-300",
  reload_page: "bg-sky-500/10 text-sky-300",
  new_tab: "bg-sky-500/10 text-sky-300",
  switch_tab: "bg-sky-500/10 text-sky-300",
  close_page: "bg-sky-500/10 text-sky-300",
  scroll: "bg-sky-500/10 text-sky-300",
...
const defaultChipTint = "bg-slate-500/10 text-slate-300";
