...
Sessions live for 5 minutes to 4 hours (default 60 minutes), and a running session can be extended through the API to 6 hours. When the timer ends or you close it manually, the browser is destroyed and its state goes with it.
