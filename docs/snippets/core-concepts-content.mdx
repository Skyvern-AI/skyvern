...
**Data and files:** Extract (pull structured data into JSON), File Download, File Upload, File Parser (PDFs, CSVs, Excel, DOCX, images, ZIP archives), and PDF Parser (specialized text extraction).
