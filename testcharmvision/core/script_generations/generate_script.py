# testcharmvision_codegen_cst.py
"""
Generate a runnable Testcharmvision workflow script.
...
from testcharmvision.core.script_generations.constants import SCRIPT_TASK_BLOCKS, SCRIPT_TASK_BLOCKS_WITH_COMPLETE_ACTION
from testcharmvision.core.script_generations.generate_workflow_parameters import (
...
from testcharmvision.schemas.workflows import FileStorageType
from testcharmvision.utils.strings import sanitize_identifier
...
def _render_value(
    ...
    if "{{" in prompt_text and "}}" in prompt_text:
        ...
        return cst.Call(
            func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name(render_func_name)),
            args=args,
        )
    else:
...
def _workflow_decorator(wf_req: dict[str, Any]) -> cst.Decorator:
    """
    Build  @testcharmvision.workflow(
    ...
    return cst.Decorator(
        decorator=cst.Call(
            func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("workflow")),
            args=args,
        )
    )
...
def _make_decorator(block_label: str, block: dict[str, Any]) -> cst.Decorator:
    ...
    return cst.Decorator(
        decorator=Call(
            func=Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("cached")),
            args=kwargs,
        )
    )
...
def _build_block_fn(block: dict[str, Any], actions: list[dict[str, Any]]) -> FunctionDef:
    ...
    return FunctionDef(
        ...
        params=cst.Parameters(
            params=[
                Param(name=Name("page"), annotation=cst.Annotation(cst.Name("TestcharmvisionPage"))),
...
def _build_run_task_statement(
    ...
    """Build a testcharmvision.run_task statement."""
    args = __build_base_task_statement(block_title, block, data_variable_name)
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("run_task")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_download_statement(
    ...
    """Build a testcharmvision.download statement."""
    args = __build_base_task_statement(block_title, block, data_variable_name)
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("download")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_action_statement(
    ...
    """Build a testcharmvision.action statement."""
    args = [
        cst.Arg(
            keyword=cst.Name("prompt"),
    ...
    _mark_last_arg_as_comma(args)
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("action")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_login_statement(
    ...
    """Build a testcharmvision.login statement."""
    args = __build_base_task_statement(block_title, block, data_variable_name)
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("login")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_extract_statement(
    ...
    """Build a testcharmvision.extract statement."""
    args = [
        cst.Arg(
            keyword=cst.Name("prompt"),
    ...
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("extract")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_navigate_statement(
    ...
    """Build a testcharmvision.navigate statement."""
    args = __build_base_task_statement(block_title, block, data_variable_name)
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("run_task")),
        args=args,
...
def _build_send_email_statement(block: dict[str, Any]) -> cst.SimpleStatementLine:
    """Build a testcharmvision.send_email statement."""
    args = [
        cst.Arg(
    ...
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("send_email")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_validate_statement(
    ...
    """Build a testcharmvision.validate statement."""
    args = []
    ...
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("validate")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_wait_statement(block: dict[str, Any]) -> cst.SimpleStatementLine:
    """Build a testcharmvision.wait statement."""
    args = [
        cst.Arg(
            keyword=cst.Name("seconds"),
    ...
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("wait")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_goto_statement(block: dict[str, Any], data_variable_name: str | None = None) -> cst.SimpleStatementLine:
    """Build a testcharmvision.goto statement."""
    args = [
        cst.Arg(
    ...
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("goto")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_code_statement(block: dict[str, Any]) -> cst.SimpleStatementLine:
    """Build a testcharmvision.run_code statement."""
    ...
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("run_code")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_file_upload_statement(block: dict[str, Any]) -> cst.SimpleStatementLine:
    """Build a testcharmvision.upload_file statement."""
    parameters = block.get("parameters", [])
    parameter_list = [parameter["key"] for parameter in parameters]
    ...
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("upload_file")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_pdf_parser_statement(block: dict[str, Any]) -> cst.SimpleStatementLine:
    """Build a testcharmvision.parse_pdf statement."""
    args = [
        cst.Arg(
    ...
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("parse_pdf")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_file_url_parser_statement(block: dict[str, Any]) -> cst.SimpleStatementLine:
    """Build a testcharmvision.parse_file statement."""
    args = [
        cst.Arg(
            keyword=cst.Name("file_url"),
            value=_value(block.get("file_url", "")),
    ...
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("parse_file")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_http_request_statement(block: dict[str, Any]) -> cst.SimpleStatementLine:
    """Build a testcharmvision.http_request statement."""
    args = [
        cst.Arg(
    ...
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("http_request")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_prompt_statement(block: dict[str, Any]) -> cst.SimpleStatementLine:
    """Build a testcharmvision.prompt statement."""
    args = [
        cst.Arg(
            keyword=cst.Name("prompt"),
    ...
    _mark_last_arg_as_comma(args)
    call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("prompt")),
        args=args,
        whitespace_before_args=cst.ParenthesizedWhitespace(
            indent=True,
            last_line=cst.SimpleWhitespace(INDENT),
...
def _build_for_loop_statement(block_title: str, block: dict[str, Any]) -> cst.For:
    ...
    ```
    async for current_value in testcharmvision.loop(context.parameters["urls"]):
        await testcharmvision.goto(
            url=current_value,
            label="block_4",
        )
        await testcharmvision.extract(
    ...
    # create testcharmvision.loop(loop_over_parameter_key, label=block_title)
    ...
    loop_call = cst.Call(
        func=cst.Attribute(value=cst.Name("testcharmvision"), attr=cst.Name("loop")),
        args=loop_call_args,
    )
    ...
    if block.get("block_type") == "task_v2":
        args.append(
            cst.Arg(
                ...
                value=_value("testcharmvision-2.0"),
                whitespace_after_arg=cst.ParenthesizedWhitespace(
                    indent=True,
                    last_line=cst.SimpleWhitespace(INDENT),
                ),
...
def _build_run_fn(blocks: list[dict[str, Any]], wf_req: dict[str, Any]) -> FunctionDef:
    body = [
        ...
        cst.parse_statement("page, context = await testcharmvision.setup(parameters, GeneratedWorkflowParameters)"),
    ]
...
async def generate_workflow_script_python_code(
    *,
    ...
    imports: list[cst.BaseStatement] = [
        ...
        cst.SimpleStatementLine([cst.Import(names=[cst.ImportAlias(cst.Name("testcharmvision"))])]),
        cst.SimpleStatementLine(
            [
                cst.ImportFrom(
                    module=cst.Name("testcharmvision"),
                    names=[
                        cst.ImportAlias(cst.Name("RunContext")),
                        cst.ImportAlias(cst.Name("TestcharmvisionPage")),
                    ],
                )
            ]
        ),
...
async def create_or_update_script_block(
    ...
    Args:
        ...
        run_signature: The function call code to execute this block (e.g., "await testcharmvision.action(...)")
    ...
    try:
        ...
        file_name = f"{block_label}.testcharmvision"
