...
export type GoogleSheetsWriteBlockParametersItem =
    | Skyvern.GoogleSheetsWriteBlockParametersItem.AwsSecret
    | Skyvern.GoogleSheetsWriteBlockParametersItem.AzureSecret
    | Skyvern.GoogleSheetsWriteBlockParametersItem.AzureVaultCredential
    | Skyvern.GoogleSheetsWriteBlockParametersItem.BitwardenCreditCardData
    | Skyvern.GoogleSheetsWriteBlockParametersItem.BitwardenLoginCredential
    | Skyvern.GoogleSheetsWriteBlockParametersItem.BitwardenSensitiveInformation
    | Skyvern.GoogleSheetsWriteBlockParametersItem.Context
    | Skyvern.GoogleSheetsWriteBlockParametersItem.Credential
    | Skyvern.GoogleSheetsWriteBlockParametersItem.Onepassword
    | Skyvern.GoogleSheetsWriteBlockParametersItem.Output
    | Skyvern.GoogleSheetsWriteBlockParametersItem.Workflow;

export namespace GoogleSheetsWriteBlockParametersItem {
