...
from testcharmvision.forge.sdk.schemas.task_v2 import ThoughtType
...
class ActionModel(Base):
    ...
    testcharmvision_element_hash = Column(String, nullable=True)
    testcharmvision_element_data = Column(JSON, nullable=True)
