...
import { TestcharmvisionBrowserPageAgent } from "./TestcharmvisionBrowserPageAgent.js";
import { TestcharmvisionBrowserPageAi } from "./TestcharmvisionBrowserPageAi.js";
 ...
 * ```
 */
export class TestcharmvisionBrowserPageCore {
    private readonly _browser: TestcharmvisionBrowser;
    private readonly _page: Page;
    private readonly _ai: TestcharmvisionBrowserPageAi;
    public readonly agent: TestcharmvisionBrowserPageAgent;
    private readonly _proxy: TestcharmvisionBrowserPage;

    private constructor(browser: TestcharmvisionBrowser, page: Page) {
        this._browser = browser;
        this._page = page;
        this._ai = new TestcharmvisionBrowserPageAi(browser, page);
        this.agent = new TestcharmvisionBrowserPageAgent(browser, page);
        ...
        }) as unknown as TestcharmvisionBrowserPage;
    }

    static create(browser: TestcharmvisionBrowser, page: Page): TestcharmvisionBrowserPage {
        const instance = new TestcharmvisionBrowserPageCore(browser, page);
    ...
    get browser(): TestcharmvisionBrowser {
...
export type TestcharmvisionBrowserPage = TestcharmvisionBrowserPageCore & Page;
