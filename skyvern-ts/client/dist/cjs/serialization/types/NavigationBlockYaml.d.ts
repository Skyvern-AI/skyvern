...
export declare const NavigationBlockYaml: core.serialization.ObjectSchema<serializers.NavigationBlockYaml.Raw, Skyvern.NavigationBlockYaml>;
export declare namespace NavigationBlockYaml {
    interface Raw {
        label: string;
