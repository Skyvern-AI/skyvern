...
sed -i.bak 's|https://github.com/Skyvern-AI/skyvern-typescript/blob/HEAD/./reference.md|https://github.com/Skyvern-AI/skyvern/blob/main/skyvern-ts/client/README.md|g' skyvern-ts/client/README.md
