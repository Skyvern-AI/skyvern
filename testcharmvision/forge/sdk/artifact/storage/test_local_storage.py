...
from testcharmvision.forge.sdk.artifact.models import ArtifactType, LogEntityType
from testcharmvision.forge.sdk.artifact.storage.local import LocalStorage
...
class TestLocalStorageBuildURIs:
    ...
    def test_build_log_uri(self, local_storage: LocalStorage) -> None:
        ...
        assert (
            uri
            == f"file://{local_storage.artifact_path}/logs/workflow_run_block/log_id/2025-06-09T12:00:00_testcharmvision_log.log"
        )
