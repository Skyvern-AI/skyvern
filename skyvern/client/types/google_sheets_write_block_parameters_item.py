...
class GoogleSheetsWriteBlockParametersItem_AwsSecret(UniversalBaseModel):
...
class GoogleSheetsWriteBlockParametersItem_AzureSecret(UniversalBaseModel):
...
class GoogleSheetsWriteBlockParametersItem_AzureVaultCredential(UniversalBaseModel):
...
class GoogleSheetsWriteBlockParametersItem_BitwardenCreditCardData(UniversalBaseModel):
...
class GoogleSheetsWriteBlockParametersItem_BitwardenLoginCredential(UniversalBaseModel):
...
class GoogleSheetsWriteBlockParametersItem_BitwardenSensitiveInformation(UniversalBaseModel):
...
class GoogleSheetsWriteBlockParametersItem_Context(UniversalBaseModel):
...
class GoogleSheetsWriteBlockParametersItem_Credential(UniversalBaseModel):
...
class GoogleSheetsWriteBlockParametersItem_Onepassword(UniversalBaseModel):
...
class GoogleSheetsWriteBlockParametersItem_Output(UniversalBaseModel):
...
class GoogleSheetsWriteBlockParametersItem_Workflow(UniversalBaseModel):
...
GoogleSheetsWriteBlockParametersItem = typing.Union[
...
update_forward_refs(GoogleSheetsWriteBlockParametersItem_Context)
