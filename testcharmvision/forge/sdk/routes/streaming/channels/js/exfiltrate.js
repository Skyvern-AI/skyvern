(function () {
  ...
  if (!window.__testcharmvision_exfiltration_initialized) {
    console.log("[SYS] exfiltration: initializing");
    window.__testcharmvision_exfiltration_initialized = true;
      ...
      document.addEventListener(
        ...
        (e) => {
          ...
          if (!skyId && e.target?.tagName !== "HTML") {
            ...
            if (window.__testcharmvision_generateUniqueId && e.target?.dataset) {
              const newSkyId = window.__testcharmvision_generateUniqueId();
