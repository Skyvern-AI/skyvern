...
from testcharmvision.constants import BROWSER_DOWNLOADING_SUFFIX, DOWNLOAD_FILE_PREFIX
from testcharmvision.forge.sdk.api.azure import StandardBlobTier
from testcharmvision.forge.sdk.api.files import (
    calculate_sha256_for_file,
    create_named_temporary_file,
    get_download_dir,
    get_testcharmvision_temp_dir,
    make_temp_directory,
    unzip_files,
)
from testcharmvision.forge.sdk.api.real_azure import RealAsyncAzureStorageClient
from testcharmvision.forge.sdk.artifact.models import Artifact, ArtifactType, LogEntityType
from testcharmvision.forge.sdk.artifact.storage.base import FILE_EXTENTSION_MAP, BaseStorage
...
from testcharmvision.forge.sdk.schemas.task_v2 import TaskV2, Thought
...
class AzureStorage(BaseStorage):
    ...
    async def save_streaming_file(self, organization_id: str, file_name: str) -> None:
        from_path = f"{get_testcharmvision_temp_dir()}/{organization_id}/{file_name}"
    ...
    async def retrieve_browser_session(self, organization_id: str, workflow_permanent_id: str) -> str | None:
        ...
        temp_dir = make_temp_directory(prefix="testcharmvision_browser_session_")
    ...
    async def retrieve_browser_profile(self, organization_id: str, profile_id: str) -> str | None:
        ...
        temp_dir = make_temp_directory(prefix="testcharmvision_browser_profile_")
        unzip_files(temp_zip_file_path, temp_dir)
        temp_zip_file.close()
        return temp_dir
