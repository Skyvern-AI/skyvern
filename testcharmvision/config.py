...
from testcharmvision import constants
from testcharmvision.constants import REPO_ROOT_DIR, TESTCHARMVISION_DIR
...
class Settings(BaseSettings):
    ...
    DATABASE_STRING: str = (
        "postgresql+asyncpg://testcharmvision@localhost/testcharmvision"
        if platform.system() == "Windows"
        else "postgresql+psycopg://testcharmvision@localhost/testcharmvision"
    )
    ...
    ARTIFACT_STORAGE_PATH: str = f"{TESTCHARMVISION_DIR}/artifacts"

    # Supported storage types: local, s3cloud, azureblob
    TESTCHARMVISION_STORAGE_TYPE: str = "local"
    ...
    AWS_S3_BUCKET_ARTIFACTS: str = "testcharmvision-artifacts"
    AWS_S3_BUCKET_SCREENSHOTS: str = "testcharmvision-screenshots"
    AWS_S3_BUCKET_BROWSER_SESSIONS: str = "testcharmvision-browser-sessions"
    AWS_S3_BUCKET_UPLOADS: str = "testcharmvision-uploads"

    # Azure Blob Storage settings
    AZURE_STORAGE_ACCOUNT_NAME: str | None = None
    AZURE_STORAGE_ACCOUNT_KEY: str | None = None
    AZURE_STORAGE_CONTAINER_ARTIFACTS: str = "testcharmvision-artifacts"
    AZURE_STORAGE_CONTAINER_SCREENSHOTS: str = "testcharmvision-screenshots"
    AZURE_STORAGE_CONTAINER_BROWSER_SESSIONS: str = "testcharmvision-browser-sessions"
    AZURE_STORAGE_CONTAINER_UPLOADS: str = "testcharmvision-uploads"

    TESTCHARMVISION_TELEMETRY: bool = True
    ...
    WORKFLOW_DOWNLOAD_DIRECTORY_PARAMETER_KEY: str = "TESTCHARMVISION_DOWNLOAD_DIRECTORY"
    ...
    # Testcharmvision Auth Bitwarden Settings
    TESTCHARMVISION_AUTH_BITWARDEN_CLIENT_ID: str | None = None
    TESTCHARMVISION_AUTH_BITWARDEN_CLIENT_SECRET: str | None = None
    TESTCHARMVISION_AUTH_BITWARDEN_MASTER_PASSWORD: str | None = None
    TESTCHARMVISION_AUTH_BITWARDEN_ORGANIZATION_ID: str | None = None
    ...
    TESTCHARMVISION_APP_URL: str = "http://localhost:8080"
    # TestcharmvisionClient Settings
    TESTCHARMVISION_BASE_URL: str = "https://api.testcharmvision.com"
    TESTCHARMVISION_API_KEY: str = "PLACEHOLDER"

    TESTCHARMVISION_BROWSER_VNC_PORT: int = 6080
    """
    ...
    OTEL_SERVICE_NAME: str = "testcharmvision"
