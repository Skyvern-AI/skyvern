...
- `skyvern-1.0`: the default engine. Performs well for tasks with a simple goal, like filling a form, or searching for information on Google.
- `skyvern-2.0`: remains available for existing V2 workflows and explicitly requested V2 task runs.
