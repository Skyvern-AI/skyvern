...
slug: cloud/live-execution
---

When you run a task from the [Discover page](/cloud/discover-page), you're taken to the live execution screen where you can watch the browser in real time.
