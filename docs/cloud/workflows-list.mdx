...
slug: cloud/workflows-list
---

The **Workflows** page is where you build and manage multi-step automations. Each workflow is a reusable sequence of blocks that you can run with different inputs each time.
...
Click the **Create** dropdown button at the top right of the table.

| Option | What it does |
|--------|-------------|
| **Blank Workflow** | Creates a new empty workflow and opens it in the [editor](/cloud/workflow-editor) |
| **From Template** | Opens a dialog showing organization templates to start from |

<img src="/images/cloud/create-workflow-dropdown.png" alt="Create workflow dropdown" />
