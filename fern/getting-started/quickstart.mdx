...
Since tasks run asychronously, you have two options:
...
async def main():
    ...
    while True:
        ...
        if run.status in ["completed", "failed", "terminated"]:
            break
...
```json
{
  "run_id": "r_abc123",
  "status": "completed",
  "recording_url": "https://app.skyvern.com/runs/r_abc123"
}
```
...
<img src="../images/visualizing_results/view_recording.png" alt="Recording tab in Skyvern Cloud" />
