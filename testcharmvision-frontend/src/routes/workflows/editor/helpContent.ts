export const baseHelpTooltipContent = {
  url: "The URL Testcharmvision is navigating to. Leave this field blank to pick up from where the last block left off.",
  navigationGoal:
    "Give Testcharmvision an objective. Make sure to include when the block is complete, when it should self-terminate, and any guardrails. Use {{ parameter_name }} to reference a parameter value",
  parameters:
    'Define placeholder values using the "parameters" drop down that you predefine or redefine run-to-run.',
  dataExtractionGoal:
    "Tell Testcharmvision what data you would like to scrape at the end of your run.",
  ...
  completeOnDownload:
    "Allow Testcharmvision to auto-complete the block when it downloads a file.",
  fileSuffix:
...
export const basePlaceholderContent = {
  ...
  navigationGoal: "Tell Testcharmvision what to do.",
...
export const helpTooltips = {
  ...
  extraction: {
    ...baseHelpTooltipContent,
    dataExtractionGoal:
      "Tell Testcharmvision what data you would like to scrape. Use {{ parameter_name }} to specify parameters to use.",
  },
  action: {
    ...baseHelpTooltipContent,
    navigationGoal:
      "Specify a single step or action you'd like Testcharmvision to complete. Actions are one-off tasks like filling a field or interacting with a specific element on the page.\n\nCurrently supported actions are click, input text, upload file, and select. Use {{ parameter_name }} to specify parameters to use.",
  },
  fileDownload: {
    ...baseHelpTooltipContent,
    navigationGoal:
      "Give Testcharmvision an objective that describes how to download the file.",
  },
...
export const placeholders = {
  ...
  taskv2: {
    ...
    prompt: "Tell Testcharmvision what to do",
  },
  navigation: {
    ...basePlaceholderContent,
    navigationGoal:
  ...
  fileDownload: {
    navigationGoal: "Tell Testcharmvision which file to download.",
  },
