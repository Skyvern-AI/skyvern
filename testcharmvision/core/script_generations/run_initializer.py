...
from testcharmvision.core.script_generations.script_testcharmvision_page import ScriptTestcharmvisionPage, script_run_context_manager
...
async def setup(
...
) -> tuple[TestcharmvisionPage, RunContext]:
    ...
    testcharmvision_page = await ScriptTestcharmvisionPage.create(browser_session_id=browser_session_id)
    run_context = RunContext(
        parameters=parameters,
        page=testcharmvision_page,
    ...
    return testcharmvision_page, run_context
