...
export type TestcharmvisionCredential = {
  key: string;
  description?: string | null;
  parameterType: "credential";
  credentialId: string;
...
export function parameterIsTestcharmvisionCredential(
  parameter: CredentialParameterState,
): parameter is TestcharmvisionCredential {
