...
**Prerequisites:**
- Skyvern server extra installed (`pip install "skyvern[server]"`)
- Source checkout or Docker Compose for guided quickstart and database migrations
...
<Note>
Docker is optional. If you have PostgreSQL installed locally, Skyvern will detect and use it automatically. Use `skyvern init --no-postgres` to skip database setup entirely if you're managing PostgreSQL separately. The PyPI wheel installs the local-server dependencies, but guided quickstart currently needs repository migration files from a source checkout.
</Note>
...
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/Skyvern-AI/skyvern-docs-media@383c5fb7f1c10a89e57a34e503b05b7ee4e80a6a/media/quickstart/8d8dc46d95f62f20c9ee6e433a1dcca0e2bb7b074fe93a2d56bc4fcd7ac85d4a-skyvern-init.gif" alt="Skyvern init interactive setup wizard" />
</p>
...
<video style={{ aspectRatio: '16 / 9', width: '100%' }} controls>
  <source src="https://cdn.jsdelivr.net/gh/Skyvern-AI/skyvern-docs-media@383c5fb7f1c10a89e57a34e503b05b7ee4e80a6a/media/quickstart/56f8b625b7ac6324f44e76fb13c14ebd546350ee97aa3ba76bceec62f579dc15-skyvern-agent-local.mp4" type="video/mp4" />
</video>
