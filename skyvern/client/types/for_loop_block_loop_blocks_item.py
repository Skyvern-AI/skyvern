...
class ForLoopBlockLoopBlocksItem_EmailInbox(UniversalBaseModel):
...
class ForLoopBlockLoopBlocksItem_GoogleSheetsRead(UniversalBaseModel):
...
class ForLoopBlockLoopBlocksItem_GoogleSheetsWrite(UniversalBaseModel):
...
class ForLoopBlockLoopBlocksItem_PdfFill(UniversalBaseModel):
...
class ForLoopBlockLoopBlocksItem_PrintPage(UniversalBaseModel):
...
class ForLoopBlockLoopBlocksItem_SplitPdf(UniversalBaseModel):
...
update_forward_refs(ForLoopBlockLoopBlocksItem_EmailInbox)
...
update_forward_refs(ForLoopBlockLoopBlocksItem_PdfFill)
update_forward_refs(ForLoopBlockLoopBlocksItem_PrintPage)
update_forward_refs(ForLoopBlockLoopBlocksItem_SplitPdf)
