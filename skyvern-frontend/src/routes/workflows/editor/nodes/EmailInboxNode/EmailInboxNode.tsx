...
import { EmailInboxEditor } from "./EmailInboxEditor";
import type { EmailInboxNode as EmailInboxNodeType } from "./types";

function EmailInboxNode({ id, data }: NodeProps<EmailInboxNodeType>) {
