...
export type WaitBlockParametersItem =
    | Skyvern.WaitBlockParametersItem.AwsSecret
    | Skyvern.WaitBlockParametersItem.AzureSecret
    | Skyvern.WaitBlockParametersItem.AzureVaultCredential
    | Skyvern.WaitBlockParametersItem.BitwardenCreditCardData
    | Skyvern.WaitBlockParametersItem.BitwardenLoginCredential
    | Skyvern.WaitBlockParametersItem.BitwardenSensitiveInformation
    | Skyvern.WaitBlockParametersItem.Context
    | Skyvern.WaitBlockParametersItem.Credential
    | Skyvern.WaitBlockParametersItem.Onepassword
    | Skyvern.WaitBlockParametersItem.Output
    | Skyvern.WaitBlockParametersItem.Workflow;
