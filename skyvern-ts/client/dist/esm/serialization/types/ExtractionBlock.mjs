...
export const ExtractionBlock = core.serialization.object({
    ...
    dataSchema: core.serialization.property("data_schema", ExtractionBlockDataSchema.optional()),
    ...
    parameters: core.serialization.list(ExtractionBlockParametersItem).optional(),
