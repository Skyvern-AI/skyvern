...
class Action(BaseModel):
    ...
    testcharmvision_element_hash: str | None = None
    testcharmvision_element_data: dict[str, Any] | None = None
    ...
    def get_xpath(self) -> str | None:
        if self.xpath:
            return self.xpath
        if not self.testcharmvision_element_data:
            return None
        if "xpath" in self.testcharmvision_element_data:
            return self.testcharmvision_element_data["xpath"]
        return None
