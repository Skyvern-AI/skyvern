...
browser_address = browser_session.browser_address # Use the browser_session created in the previous step
download_path = browser_session.download_path # Use the browser_session created in the previous step

with sync_playwright() as playwright: # 
    browser = playwright.chromium.connect_over_cdp(browser_address)
    ...
    page.goto("https://www.skyvern.com")
```
