...
export type PdfFillBlockParametersItem =
    | Skyvern.PdfFillBlockParametersItem.AwsSecret
    | Skyvern.PdfFillBlockParametersItem.AzureSecret
    | Skyvern.PdfFillBlockParametersItem.AzureVaultCredential
    | Skyvern.PdfFillBlockParametersItem.BitwardenCreditCardData
    | Skyvern.PdfFillBlockParametersItem.BitwardenLoginCredential
    | Skyvern.PdfFillBlockParametersItem.BitwardenSensitiveInformation
    | Skyvern.PdfFillBlockParametersItem.Context
    | Skyvern.PdfFillBlockParametersItem.Credential
    | Skyvern.PdfFillBlockParametersItem.Onepassword
    | Skyvern.PdfFillBlockParametersItem.Output
    | Skyvern.PdfFillBlockParametersItem.Workflow;

export namespace PdfFillBlockParametersItem {
