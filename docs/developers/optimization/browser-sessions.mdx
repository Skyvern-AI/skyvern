...
|-----------|------|-------------|
| `timeout` | integer | Session lifetime in minutes. Min: 5. Max: 240 (4 hours). Requests above 240 are capped at 240; the response `warning` field explains the cap. Default: `60`. |
