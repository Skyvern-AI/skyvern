...
class PrintPageBlockParametersItem_AwsSecret(UniversalBaseModel):
...
class PrintPageBlockParametersItem_AzureSecret(UniversalBaseModel):
...
class PrintPageBlockParametersItem_AzureVaultCredential(UniversalBaseModel):
...
class PrintPageBlockParametersItem_BitwardenCreditCardData(UniversalBaseModel):
...
class PrintPageBlockParametersItem_BitwardenLoginCredential(UniversalBaseModel):
...
class PrintPageBlockParametersItem_BitwardenSensitiveInformation(UniversalBaseModel):
...
class PrintPageBlockParametersItem_Context(UniversalBaseModel):
...
class PrintPageBlockParametersItem_Credential(UniversalBaseModel):
...
class PrintPageBlockParametersItem_Onepassword(UniversalBaseModel):
...
class PrintPageBlockParametersItem_Output(UniversalBaseModel):
...
class PrintPageBlockParametersItem_Workflow(UniversalBaseModel):
...
PrintPageBlockParametersItem = typing.Union[
...
update_forward_refs(PrintPageBlockParametersItem_Context)
