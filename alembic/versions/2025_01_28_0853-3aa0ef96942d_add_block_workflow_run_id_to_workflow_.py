...
def upgrade() -> None:
    ...
    with op.batch_alter_table("workflow_run_blocks") as batch_op:
        batch_op.create_foreign_key("fk_workflow_run_blocks_workflow_runs", "workflow_runs", ["block_workflow_run_id"], ["workflow_run_id"])
    ...
    with op.batch_alter_table("workflow_runs") as batch_op:
        batch_op.create_foreign_key("fk_workflow_runs_parent_workflow_runs", "workflow_runs", ["parent_workflow_run_id"], ["workflow_run_id"])
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("workflow_runs") as batch_op:
        batch_op.drop_constraint("fk_workflow_runs_parent_workflow_runs", type_="foreignkey")
    ...
    with op.batch_alter_table("workflow_run_blocks") as batch_op:
        batch_op.drop_constraint("fk_workflow_run_blocks_workflow_runs", type_="foreignkey")
