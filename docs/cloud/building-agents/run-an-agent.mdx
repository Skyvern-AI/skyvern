...
subtitle: Execute agents, fill parameters, and track status
description: Execute agents from the Skyvern Cloud UI editor or agents list, fill in runtime parameters, configure run settings like proxy and webhook, and monitor live execution.
...
<img src="/images/cloud/run-wf-1.png" alt="Agent editor with the Run button highlighted in the header bar" />

2. **From the agents list**: Click the **play icon** on the agent's row.

<img src="/images/cloud/run-wf-2.png" alt="Agents list page with play icon to start a run from the list" />
...
<img src="/images/cloud/run-wf-3.png" alt="Parameters page showing input fields and settings before starting an agent run" />
...
<img src="/images/cloud/workflow-run-timeline.png" alt="Agent run block timeline" />
...
<img src="/images/cloud/run-wf-8.png" alt="Completed agent run showing extracted data, output tabs, and block timeline" />
...
<img src="/images/cloud/run-wf-5.png" alt="Past Runs view for a specific agent showing run statuses and timestamps" />
