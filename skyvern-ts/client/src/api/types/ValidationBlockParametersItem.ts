...
export type ValidationBlockParametersItem =
    | Skyvern.ValidationBlockParametersItem.AwsSecret
    | Skyvern.ValidationBlockParametersItem.AzureSecret
    | Skyvern.ValidationBlockParametersItem.AzureVaultCredential
    | Skyvern.ValidationBlockParametersItem.BitwardenCreditCardData
    | Skyvern.ValidationBlockParametersItem.BitwardenLoginCredential
    | Skyvern.ValidationBlockParametersItem.BitwardenSensitiveInformation
    | Skyvern.ValidationBlockParametersItem.Context
    | Skyvern.ValidationBlockParametersItem.Credential
    | Skyvern.ValidationBlockParametersItem.Onepassword
    | Skyvern.ValidationBlockParametersItem.Output
    | Skyvern.ValidationBlockParametersItem.Workflow;
