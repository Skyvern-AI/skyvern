...
TESTCHARMVISION_ID_ATTR: str = "unique_id"
TESTCHARMVISION_DIR = Path(__file__).parent
REPO_ROOT_DIR = TESTCHARMVISION_DIR.parent
...
# TestcharmvisionPage constants
TESTCHARMVISION_PAGE_MAX_SCRAPING_RETRIES = 2
