...
const urlTooltip =
  "The URL Testcharmvision is navigating to. Leave this field blank to pick up from where the last block left off.";
const urlPlaceholder = "https://";
const navigationGoalTooltip =
  "Give Testcharmvision an objective that describes how to download the file.";
const navigationGoalPlaceholder = "Tell Testcharmvision which file to download.";
