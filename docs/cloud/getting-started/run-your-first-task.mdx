...
Click the **send button** (arrow icon to the right of the input). Skyvern generates an agent from your prompt using the default Skyvern 1.0 task engine and opens it in the agent editor. Click **Run** in the top right, confirm the parameters, then click **Run agent** to start execution.
...
| **Publish Agent** | Create an agent alongside this task run |
...
Your result will differ, since the #1 post changes constantly. The structure is what matters.
...
- **Navigate a flow**: Build an agent to walk through a multi-page checkout or signup process
...
<CardGroup cols={2}>
  ...
  >
    Understand tasks, agents, and other building blocks
  </Card>
</CardGroup>
