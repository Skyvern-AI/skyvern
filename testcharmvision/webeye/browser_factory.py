...
from testcharmvision.exceptions import UnknownBrowserType, UnknownErrorWhileCreatingBrowserContext
from testcharmvision.forge import app
from testcharmvision.forge.sdk.api.files import get_download_dir, make_temp_directory
from testcharmvision.forge.sdk.core.testcharmvision_context import current, ensure_context
from testcharmvision.schemas.runs import ProxyLocation, get_tzinfo_from_proxy
...
class BrowserContextFactory:
    ...
    def update_chromium_browser_preferences(user_data_dir: str, download_dir: str) -> None:
        ...
        preference_template = f"{TESTCHARMVISION_DIR}/webeye/chromium_preferences.json"
...
async def _create_headless_chromium(
    ...
    **kwargs: dict,
    ...
    if not user_data_dir:
        user_data_dir = make_temp_directory(prefix="testcharmvision_browser_")
