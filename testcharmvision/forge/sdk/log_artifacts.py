...
from testcharmvision.forge.testcharmvision_json_encoder import TestcharmvisionJSONLogEncoder
from testcharmvision.forge.testcharmvision_log_encoder import TestcharmvisionLogEncoder
    ...
    *,
    ...
    try:
        ...
        if not organization_id:
            ...
            return
        log_json = json.dumps(log, cls=TestcharmvisionJSONLogEncoder, indent=2)

        log_artifact = await app.DATABASE.get_artifact_by_entity_id(
            artifact_type=ArtifactType.TESTCHARMVISION_LOG_RAW,
            step_id=step_id,
            task_id=task_id,
            workflow_run_id=workflow_run_id,
            workflow_run_block_id=workflow_run_block_id,
        ...
        formatted_log = TestcharmvisionLogEncoder.encode(log)
