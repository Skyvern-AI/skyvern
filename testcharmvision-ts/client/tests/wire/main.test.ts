...
import * as Testcharmvision from "../../src/api/index";
import { TestcharmvisionClient } from "../../src/Client";
import { mockServerPool } from "../mock-server/MockServerPool";

describe("TestcharmvisionClient", () => {
    test("run_task (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new TestcharmvisionClient({ apiKey: "test", environment: server.baseUrl });
    ...
    test("run_task (2)", async () => {
        ...
        }).rejects.toThrow(Testcharmvision.BadRequestError);
    });
    ...
    test("run_task (3)", async () => {
        ...
        }).rejects.toThrow(Testcharmvision.UnprocessableEntityError);
    });
    ...
    test("get_run (2)", async () => {
        ...
        }).rejects.toThrow(Testcharmvision.NotFoundError);
    });
    ...
    test("create_browser_profile (3)", async () => {
        ...
        }).rejects.toThrow(Testcharmvision.ConflictError);
    });
    ...
    test("get_browser_sessions (2)", async () => {
        ...
        }).rejects.toThrow(Testcharmvision.ForbiddenError);
    });
    ...
    test("login (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new TestcharmvisionClient({ apiKey: "test", environment: server.baseUrl });
        const rawRequestBody = { credential_type: "testcharmvision" };
        const rawResponseBody = {
            run_id: "tsk_123",
            status: "created",
            output: { key: "value" },
