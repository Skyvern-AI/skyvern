...
from testcharmvision.forge.sdk.trace.base import BaseTrace
...
class LaminarTrace(BaseTrace):
    def __init__(self, api_key: str) -> None:
        Laminar.initialize(project_api_key=api_key, disabled_instruments={Instruments.TESTCHARMVISION, Instruments.PATCHRIGHT})
