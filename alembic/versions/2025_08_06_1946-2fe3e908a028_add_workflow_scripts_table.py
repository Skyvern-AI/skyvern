...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('workflow_permanent_id', 'cache_key_value', name='uc_workflow_permanent_id_cache_key_value')
    )
    op.create_index('idx_workflow_scripts_org_created', 'workflow_scripts', ['organization_id', 'created_at'], unique=False)
    op.create_index('idx_workflow_scripts_workflow_permanent_id', 'workflow_scripts', ['workflow_permanent_id'], unique=False)
