...
<img src="/images/cloud/viewing-results/run-history-overview.png" alt="Run History page overview" />
...
<img src="/images/cloud/viewing-results/run-history-search.png" alt="Searching for a run by ID" />
