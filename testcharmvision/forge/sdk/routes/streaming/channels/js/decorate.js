(function () {
  ...
  function initiate() {
    if (!window.__testcharmvision_decoration_initialized) {
      console.log("[SYS] decorate: initializing");

      window.__testcharmvision_decoration_initialized = true;

      window.__testcharmvision_create_mouse_follower = function () {
        const preexistingCircles = document.querySelectorAll(
          "#__testcharmvision_mouse_follower",
        );
        ...
        window.__testcharmvision_decoration_mouse_follower = circle;
        circle.id = "__testcharmvision_mouse_follower";
      ...
      window.__testcharmvision_create_mouse_follower();
      ...
      function animate() {
        if (!window.__testcharmvision_decoration_mouse_follower) {
          return;
        }

        const follower = window.__testcharmvision_decoration_mouse_follower;
