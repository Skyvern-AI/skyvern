...
description: Launch a cloud browser, navigate to a page, and extract data using Skyvern's Page/Agent/Browser SDK. Works in Python, TypeScript, or cURL in under 5 minutes.
...
Run your first browser automation in 5 minutes. By the end of this guide, you'll launch a cloud browser, navigate to Hacker News, and extract the top post title using Skyvern's Page/Agent/Browser SDK.
...
The pattern is always the same: launch a browser, get a page, use AI methods on the page, close the browser.
