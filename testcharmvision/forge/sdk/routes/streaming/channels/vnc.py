...
What this channel looks like:
    ...
    [Testcharmvision App] <--> [API Server] <--> [websockified noVNC] <--> [Browser]
...
from testcharmvision.forge.sdk.routes.streaming.auth import get_x_api_key
from testcharmvision.forge.sdk.routes.streaming.channels.execution import execution_channel
from testcharmvision.forge.sdk.routes.streaming.registries import (
    add_vnc_channel,
    del_vnc_channel,
    get_message_channel,
    get_vnc_channel,
)
from testcharmvision.forge.sdk.routes.streaming.verify import (
...
from testcharmvision.forge.sdk.schemas.persistent_browser_sessions import AddressablePersistentBrowserSession
from testcharmvision.forge.sdk.schemas.tasks import Task
from testcharmvision.forge.sdk.utils.aio import collect
from testcharmvision.forge.sdk.workflow.models.workflow import WorkflowRun
...
async def get_vnc_channel_for_browser_session(
    ...
    try:
        vnc_channel = VncChannel(
            ...
            organization_id=organization_id,
            vnc_port=settings.TESTCHARMVISION_BROWSER_VNC_PORT,
