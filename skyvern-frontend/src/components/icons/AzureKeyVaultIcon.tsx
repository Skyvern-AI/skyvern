...
function AzureKeyVaultIcon({ className }: Props) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="url(#azureKeyVaultIconGradA)"
      ...
      />
      <path
        fill="url(#azureKeyVaultIconGradB)"
      ...
      />
      <path
        fill="url(#azureKeyVaultIconGradC)"
