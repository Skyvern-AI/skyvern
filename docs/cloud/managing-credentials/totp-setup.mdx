...
<Steps>
  <Step title="Create a password credential">
    ...
    <img src="/images/cloud/totp-setup-1.png" alt="API Keys settings page" />
  </Step>
  ...
  <Step title="Paste your TOTP secret key">
    ...
    <img src="/images/cloud/totp-setup-2.png" alt="API Keys settings page" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Enter the identifier">
    ...
    <img src="/images/cloud/totp-setup-3.png" alt="API Keys settings page" />
  </Step>
</Steps>
