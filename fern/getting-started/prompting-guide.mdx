...
- **Use clear visual indicators and phrases to capture the main goal and completion criteria.**
    - For instance, if you goal is to navigate to a certain page, you can say “using the sales dropdown at the top of the page” or “to navigate to invoices, the button has a receipt icon”
