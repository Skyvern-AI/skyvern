...
| `testcharmvision/services/workflow_script_service.py` | Caching logic, script storage |
| `testcharmvision/forge/sdk/workflow/service.py` | Regeneration decision logic (`generate_script_if_needed`) |
