...
If you prefer writing automation code in Python or TypeScript, see [Browser Automation](/multi-step-automations/overview) in the developer docs. Both approaches handle multi-step work across pages. Workflows are the visual path, browser automations are the code path.
