...
interface ViewAllCredentialFoldersDialogProps {
  open: boolean;
...
function ViewAllCredentialFoldersDialog({
  open,
  onOpenChange,
  selectedFolderId,
  onFolderSelect,
}: ViewAllCredentialFoldersDialogProps) {
...
export { ViewAllCredentialFoldersDialog };
