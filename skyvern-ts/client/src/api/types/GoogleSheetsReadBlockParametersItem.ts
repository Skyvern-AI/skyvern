...
export type GoogleSheetsReadBlockParametersItem =
    | Skyvern.GoogleSheetsReadBlockParametersItem.AwsSecret
    | Skyvern.GoogleSheetsReadBlockParametersItem.AzureSecret
    | Skyvern.GoogleSheetsReadBlockParametersItem.AzureVaultCredential
    | Skyvern.GoogleSheetsReadBlockParametersItem.BitwardenCreditCardData
    | Skyvern.GoogleSheetsReadBlockParametersItem.BitwardenLoginCredential
    | Skyvern.GoogleSheetsReadBlockParametersItem.BitwardenSensitiveInformation
    | Skyvern.GoogleSheetsReadBlockParametersItem.Context
    | Skyvern.GoogleSheetsReadBlockParametersItem.Credential
    | Skyvern.GoogleSheetsReadBlockParametersItem.Onepassword
    | Skyvern.GoogleSheetsReadBlockParametersItem.Output
    | Skyvern.GoogleSheetsReadBlockParametersItem.Workflow;

export namespace GoogleSheetsReadBlockParametersItem {
