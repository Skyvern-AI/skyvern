...
export declare const TextPromptBlockParametersItem: core.serialization.Schema<serializers.TextPromptBlockParametersItem.Raw, Skyvern.TextPromptBlockParametersItem>;
export declare namespace TextPromptBlockParametersItem {
    type Raw = TextPromptBlockParametersItem.AwsSecret | TextPromptBlockParametersItem.AzureSecret | TextPromptBlockParametersItem.AzureVaultCredential | TextPromptBlockParametersItem.BitwardenCreditCardData | TextPromptBlockParametersItem.BitwardenLoginCredential | TextPromptBlockParametersItem.BitwardenSensitiveInformation | TextPromptBlockParametersItem.Context | TextPromptBlockParametersItem.Credential | TextPromptBlockParametersItem.Onepassword | TextPromptBlockParametersItem.Output | TextPromptBlockParametersItem.Workflow;
