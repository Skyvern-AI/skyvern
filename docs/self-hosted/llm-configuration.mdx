...
**Best models for production (2026):**
...
<Tip>
**New in 2026:** GPT-5.5, Claude Opus 4.7, Claude Sonnet 4.6, Gemini 3.1 Flash Lite, DeepSeek V4, and many new open-source models via Novita and VolcEngine.
</Tip>
...
|---------|-------|
| **GPT-5.5** | |
| `OPENAI_GPT5_5` | Latest flagship, recommended for complex tasks |
| **GPT-5 Series** | |
| `OPENAI_GPT5_4` | |
| `OPENAI_GPT5` | |
| `OPENAI_GPT5_MINI` | |
...
| `GEMINI_3.1_FLASH_LITE` | Fastest, most cost-efficient |
| **Gemini 2.5** | |
| `GEMINI_2.5_PRO` | |
...
| `VERTEX_GEMINI_3.1_FLASH_LITE` | Fastest, most cost-efficient |
| **Gemini 2.5** | |
...
SECONDARY_LLM_KEY=ANTHROPIC_CLAUDE4.6_SONNET
# or: OPENAI_GPT5_4
# or: GEMINI_3.0_FLASH
```
...
- **Claude 4.6 Sonnet** (`ANTHROPIC_CLAUDE4.6_SONNET`) - Balanced
- **GPT-5.4** (`OPENAI_GPT5_4`) - Fast reasoning
...
```bash .env
SECONDARY_LLM_KEY=OPENAI_GPT5_4
```
...
3. Model names are case-sensitive: `OPENAI_GPT5_5` not `openai_gpt5_5`
