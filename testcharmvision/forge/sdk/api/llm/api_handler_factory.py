...
from testcharmvision.exceptions import TestcharmvisionContextWindowExceededError
from testcharmvision.forge import app
from testcharmvision.forge.forge_openai_client import ForgeAsyncHttpxClientWrapper
from testcharmvision.forge.sdk.api.llm.api_handler import LLMAPIHandler, dummy_llm_api_handler
...
from testcharmvision.forge.sdk.api.llm.models import (
    LLMAllowedFailsPolicy,
    LLMConfig,
    LLMRouterConfig,
)
from testcharmvision.forge.sdk.api.llm.ui_tars_response import UITarsResponse
from testcharmvision.forge.sdk.api.llm.utils import llm_messages_builder, llm_messages_builder_with_history, parse_api_response
...
from testcharmvision.forge.sdk.models import SpeculativeLLMMetadata, Step
...
from testcharmvision.utils.image_resizer import Resolution, get_resize_target_dimension, resize_screenshots
        ...
        async def llm_api_handler_with_router_and_fallback(
            ...
            try:
                ...
                try:
                    ...
                    raise TestcharmvisionContextWindowExceededError() from e
    ...
    async def _dispatch_llm_call(
        ...
        **active_parameters: dict[str, Any],
        ...
        if self.openai_client:
            ...
            extra_headers = {}
            if settings.TESTCHARMVISION_APP_URL:
                extra_headers["HTTP-Referer"] = settings.TESTCHARMVISION_APP_URL
                extra_headers["X-Title"] = "Testcharmvision"
