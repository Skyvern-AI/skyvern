...
<Warning>
Treat your API key like a password. Organization API keys have administrator-level access. Anyone with the key can create runs, read results, manage agents, manage credentials and secrets, rotate API keys, and change billing. Rotate the key immediately if you suspect it has been shared.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="shield-check"
    href="/cloud/account-settings/authentication-and-permissions"
  >
