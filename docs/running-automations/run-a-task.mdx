...
When your automation spans multiple pages, requires login before extraction, or chains several actions together, you have two options:
...
<CardGroup cols={2}>
  ...
  >
    Chain Page, Agent, and Browser operations in Python or TypeScript. Full Playwright control with AI fallback.
  </Card>
  <Card
  ...
  >
    Build multi-step automations visually in the Cloud UI with drag-and-drop blocks. Run them from code with `run_workflow`.
  </Card>
</CardGroup>
