...
class SkyvernClient:
    ...
    async def run_task(
        ...
        return TaskRunResponse.model_validate(task_run_obj.to_dict())
    ...
    async def run_workflow(
        ...
        return WorkflowRunResponse.model_validate(workflow_run_obj.to_dict())
    ...
    async def get_run(
        ...
        if run_obj.run_type in [RunType.task_v1, RunType.task_v2]:
            return TaskRunResponse.model_validate(run_obj.to_dict())
        elif run_obj.run_type == RunType.workflow_run:
            return WorkflowRunResponse.model_validate(run_obj.to_dict())
