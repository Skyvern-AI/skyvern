...
import type { TerminateNode } from "./types";
import { TerminateEditor } from "./TerminateEditor";

function TerminateNode({ id, data, type }: NodeProps<TerminateNode>) {
