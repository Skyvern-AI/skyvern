...
def upgrade() -> None:
    ...
    with op.batch_alter_table("artifacts") as batch_op:
        batch_op.drop_constraint("artifacts_workflow_run_id_fkey", type_="foreignkey")
        batch_op.drop_constraint("artifacts_observer_cruise_id_fkey", type_="foreignkey")
        batch_op.drop_constraint("artifacts_observer_thought_id_fkey", type_="foreignkey")
        batch_op.drop_constraint("artifacts_workflow_run_block_id_fkey", type_="foreignkey")
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("artifacts") as batch_op:
        ...
        batch_op.create_foreign_key(
            "artifacts_workflow_run_id_fkey", "workflow_runs", ["workflow_run_id"], ["workflow_run_id"]
        )
