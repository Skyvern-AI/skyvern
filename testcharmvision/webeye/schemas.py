...
from testcharmvision.constants import GET_DOWNLOADED_FILES_TIMEOUT
...
class BrowserSessionResponse(BaseModel):
    ...
    app_url: str | None = Field(
        ...
        examples=["https://app.testcharmvision.com/browser-session/pbs_123456"],
    )
    ...
    async def from_browser_session(
        ...
        """
        app_url = (
            f"{settings.TESTCHARMVISION_APP_URL.rstrip('/')}/browser-session/{browser_session.persistent_browser_session_id}"
        )
        download_path = (
