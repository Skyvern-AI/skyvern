...
from testcharmvision.library.testcharmvision_browser_page import TestcharmvisionBrowserPage

if TYPE_CHECKING:
    from testcharmvision.library.testcharmvision import Testcharmvision


class TestcharmvisionBrowser(BrowserContext):
    ...
    Example:
        ```python
            ...
            browser = await testcharmvision.launch_local_browser()
    ...
    def __init__(
        ...
        *,
        ...
        self._testcharmvision = testcharmvision
    ...
    @property
    def testcharmvision(self) -> "Testcharmvision":
        return self._testcharmvision

    async def get_working_page(self) -> TestcharmvisionBrowserPage:
        ...
        Returns:
            TestcharmvisionBrowserPage: The most recent page wrapped with Testcharmvision capabilities.
        """
        if self._browser_context.pages:
            page = self._browser_context.pages[-1]
        else:
            page = await self._browser_context.new_page()
        return await self._create_testcharmvision_page(page)

    async def new_page(self) -> TestcharmvisionBrowserPage:
        ...
        Returns:
            TestcharmvisionBrowserPage: A new page wrapped with Testcharmvision capabilities.
        """
        page = await self._browser_context.new_page()
        return await self._create_testcharmvision_page(page)

    async def _create_testcharmvision_page(self, page: Page) -> TestcharmvisionBrowserPage:
        return TestcharmvisionBrowserPage(self, page)
    ...
    async def close(self, **kwargs: Any) -> None:
        ...
        if self._browser_session_id:
            await self._testcharmvision.close_browser_session(self._browser_session_id)
