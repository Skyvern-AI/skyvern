...
When triggering the rest of your task / workflow, you can pass the one time login link as the starting point (eg url parameter), and Skyvern will the new session already logged in.