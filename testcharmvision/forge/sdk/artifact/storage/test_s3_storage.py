...
from testcharmvision.forge.sdk.api.aws import S3StorageClass, S3Uri, tag_set_to_dict
...
from testcharmvision.forge.sdk.artifact.storage.test_helpers import (
...
from testcharmvision.forge.sdk.db.id import generate_artifact_id

# Test constants
TEST_BUCKET = "test-testcharmvision-bucket"
...
class TestS3StorageBuildURIs:
    ...
    def test_build_log_uri(self, s3_storage: S3Storage) -> None:
        uri = s3_storage.build_log_uri(
            ...
            artifact_type=ArtifactType.TESTCHARMVISION_LOG,
        )
        assert (
            uri
            == f"s3://{TEST_BUCKET}/v1/{settings.ENV}/{TEST_ORGANIZATION_ID}/logs/workflow_run_block/log_id/2025-06-09T12:00:00_testcharmvision_log.log"
        )
