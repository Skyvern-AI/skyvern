...
run_task_v1 = FunctionTool.from_defaults(
    async_fn=lambda task, api_key, endpoint="https://api.skyvern.com":  RemoteAgent(api_key, endpoint).run_task_v1(TaskV1Request.model_validate(task)),
...
get_task_v1 = FunctionTool.from_defaults(
    async_fn=lambda task_id, api_key, endpoint="https://api.skyvern.com":  RemoteAgent(api_key, endpoint).get_task_v1(task_id),
...
run_task_v2 = FunctionTool.from_defaults(
    async_fn=lambda task, api_key, endpoint="https://api.skyvern.com":  RemoteAgent(api_key, endpoint).run_task_v2(TaskV2Request.model_validate(task)),
...
get_task_v2 = FunctionTool.from_defaults(
    async_fn=lambda task_id, api_key, endpoint="https://api.skyvern.com":  RemoteAgent(api_key, endpoint).get_task_v2(task_id),
