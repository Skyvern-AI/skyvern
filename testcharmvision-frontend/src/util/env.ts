...
const buildTimeApiKey: string | null =
  typeof import.meta.env.VITE_TESTCHARMVISION_API_KEY === "string"
    ? import.meta.env.VITE_TESTCHARMVISION_API_KEY
    : null;
...
const API_KEY_STORAGE_KEY = "testcharmvision.apiKey";

const lsKeys = {
  browserSessionId: "testcharmvision.browserSessionId",
