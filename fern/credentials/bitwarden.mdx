...
The CLI server provides these endpoints on port 11001:
...
1. Verify CLI server is running: `curl http://localhost:11001/status`
2. Check that `BITWARDEN_SERVER=http://localhost` and `BITWARDEN_SERVER_PORT=11001`
