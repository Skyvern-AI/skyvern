...
|-----------|------|---------|-------------|
| `timeout` | `int` | `None` | Session timeout in minutes (min 5, max 240). Requests above 240 are capped at 240 and the response includes a `warning` field explaining the cap. Server default: 60 minutes. |
