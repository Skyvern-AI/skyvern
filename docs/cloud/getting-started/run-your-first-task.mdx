...
Click the **send button** (arrow icon to the right of the input). Skyvern generates a workflow from your prompt using the default Skyvern 1.0 task engine and opens it in the workflow editor. Click **Run** in the top right, confirm the parameters, then click **Run workflow** to start execution.
...
- **Navigate a flow**: Build a workflow to walk through a multi-page checkout or signup process
