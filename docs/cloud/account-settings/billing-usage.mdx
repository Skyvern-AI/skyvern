...
Skyvern bills per **credit**: each browser action the AI takes during a run consumes credits. You pay for real work, not for agents created or credentials stored.
