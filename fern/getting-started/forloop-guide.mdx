...
The structure for adding the current value parameter is always {{blockname.current_value}}

In this case the block name is **search_case** so the parameter is **{{search_case.current_value}}**
