...
def update_or_add_env_var(key: str, value: str) -> None:
    ...
    if not env_path.exists():
        ...
        defaults = {
            ...
            "DATABASE_STRING": "postgresql+psycopg://testcharmvision@localhost/testcharmvision",
            "PORT": "8000",
    ...
    if not model_options:
        console.print(
            Panel(
                ...
                "You won't be able to run Testcharmvision unless you enable at least one provider.\n"
