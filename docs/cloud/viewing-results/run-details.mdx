...
description: Inspect the details of any task or agent run in the Skyvern Cloud UI, including AI reasoning timelines, extracted data, recordings, screenshots, and parameters.
...
<img src="/images/cloud/task-run-details.png" alt="Run details page showing a completed agent run" />
...
<img src="/images/cloud/workflow-run-timeline.png" alt="A running agent with live browser view and timeline" />
...
<img src="/images/cloud/task-run-results.png" alt="Agent Run Outputs showing extracted JSON data" />
