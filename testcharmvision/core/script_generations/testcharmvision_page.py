...
from testcharmvision.forge.sdk.api.files import download_file as download_file_from_url
from testcharmvision.forge.sdk.core import testcharmvision_context
from testcharmvision.library.ai_locator import AILocator
...
if TYPE_CHECKING:
    ...
    from testcharmvision.webeye.actions.responses import ActionResult
...
class TestcharmvisionPage(Page):
    """
    ...
    def action_wrap(
        ...
        def decorator(fn: Callable) -> Callable:
            async def wrapper(
                testcharmvision_page: TestcharmvisionPage,
                *args: Any,
                **kwargs: Any,
            ) -> Any:
                return await testcharmvision_page._decorate_call(fn, action, *args, **kwargs)
...
class RunContext:
    def __init__(
        self, parameters: dict[str, Any], page: TestcharmvisionPage, generated_parameters: dict[str, Any] | None = None
    ) -> None:
