...
import { ActionBlockDataSchema } from "./ActionBlockDataSchema.mjs";
import { ActionBlockParametersItem } from "./ActionBlockParametersItem.mjs";
import { OutputParameter } from "./OutputParameter.mjs";
import { RunEngine } from "./RunEngine.mjs";
export declare const ActionBlock: core.serialization.ObjectSchema<serializers.ActionBlock.Raw, Skyvern.ActionBlock>;
export declare namespace ActionBlock {
    interface Raw {
        label: string;
        ...
        data_schema?: ActionBlockDataSchema.Raw | null;
        error_code_mapping?: Record<string, string | null | undefined> | null;
        max_retries?: number | null;
        max_steps_per_run?: number | null;
        parameters?: ActionBlockParametersItem.Raw[] | null;
