      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Set up testcharmvision in your environment and run the code on your own.
            </DialogDescription>
          </DialogHeader>
          <div>
            <div>1. Install testcharmvision: {bash("pip install testcharmvision")}</div>
            <div>2. Set up testcharmvision: {bash("testcharmvision quickstart")}</div>
            <div>
            ...
            <div>
              4. Run the code:{" "}
              {bash(
                'testcharmvision run code --params \'{"param1": "val1", "param2": "val2"}\' main.py',
              )}
            </div>
          </div>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Saving will delete cached code, and Testcharmvision will re-generate it in
        ...
        <div className="relative flex h-full w-full overflow-hidden overflow-x-hidden">
          ...
          >
            ...
            <div className="relative h-full w-full">
              <div
                className={cn(
                  "testcharmvision-split-left flex h-full w-[200%] translate-x-[-50%] transition-none duration-300",
                  {
                    "w-[100%] translate-x-0":
            ...
            <div className="testcharmvision-split-right relative flex h-full items-end justify-center bg-[#020617] p-4 pl-6">
              ...
              <div className="flex h-[calc(100%_-_8rem)] w-full gap-6">
                ...
                {(!activeDebugSession ||
                  ...
                  <div className="testcharmvision-vnc-browser flex h-full w-[calc(100%_-_6rem)] flex-1 flex-col items-center justify-center">
                ...
                {activeDebugSession &&
                  !activeDebugSession.vnc_streaming_supported && (
                    <div className="testcharmvision-screenshot-browser flex h-full w-[calc(100%_-_6rem)] flex-1 flex-col items-center justify-center">
                ...
                <div
                  className={cn(
                    ...
                    {
                      "testcharmvision-animate-nudge": nudge,
                    },
                    {
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        ...
                        {
                          "testcharmvision-animate-ghost": nudge,
                        },
                      )}
                    />
