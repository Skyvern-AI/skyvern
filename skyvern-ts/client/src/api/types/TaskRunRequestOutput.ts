...
export interface TaskRunRequestOutput {
    /**
     ...
     */
    proxy_location?: TaskRunRequestOutput.ProxyLocation;
    /**
     ...
     */
    data_extraction_schema?: TaskRunRequestOutput.DataExtractionSchema;
    /**
...
export namespace TaskRunRequestOutput {
    /**
     *
     * Geographic Proxy location to route the browser traffic through. This is only available in Skyvern Cloud.
     *
