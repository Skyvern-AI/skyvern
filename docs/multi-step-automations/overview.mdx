...
For browser launch options (timeouts, proxies, connecting to local browsers), see [Managing Browsers](/multi-step-automations/handle-browsers).
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="browser"
    href="/multi-step-automations/handle-browsers"
  >
