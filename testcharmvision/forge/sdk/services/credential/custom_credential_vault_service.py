...
from testcharmvision.exceptions import TestcharmvisionException
...
from testcharmvision.forge.sdk.schemas.credentials import (
...
class CustomCredentialConfigurationError(TestcharmvisionException):
...
class CustomCredentialVaultService(CredentialVaultService):
    ...
    async def create_credential(self, organization_id: str, data: CreateCredentialRequest) -> Credential:
        ...
        try:
            ...
            # Create record in Testcharmvision database
            try:
    ...
    async def delete_credential(self, credential: Credential) -> None:
        ...
        try:
            ...
            # Delete from Testcharmvision database after successful external deletion
