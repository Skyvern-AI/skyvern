  ...
  return (
    <>
      <div className="w-full h-full px-4 max-w-screen-2xl mx-auto">
        ...
        <div className="pl-72 h-24 flex justify-end items-center px-6 gap-2">
          <Link to="https://discord.com/invite/fG2XXEuQX3">
            <DiscordLogoIcon className="w-6 h-6 text-gray-400 hover:text-white" />
          </Link>
          <Link to="https://github.com/Skyvern-AI/skyvern">
