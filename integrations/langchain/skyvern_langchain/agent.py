...
async def run_task_v1(**kwargs: Dict[str, Any]) -> TaskResponse:
    """Use Skyvern agent to run a v1 task. It is usually used for the simple tasks."""
...
async def run_task_v_2(**kwargs: Dict[str, Any]) -> ObserverTask:
    """Use Skyvern agent to run a v2 task. It is usually used for the complicated tasks."""
...
@tool("create-skyvern-agent-task-v1", args_schema=TaskV1Request)
async def create_task_v1(**kwargs: Dict[str, Any]) -> CreateTaskResponse:
    """Use Skyvern agent to create a v1 task. It is usually used for the simple tasks."""
    task_request = TaskV1Request(**kwargs)
...
@tool("create-skyvern-agent-task-v2", args_schema=TaskV2Request)
async def create_task_v_2(**kwargs: Dict[str, Any]) -> ObserverTask:
    """Use Skyvern agent to create a v2 task. It is usually used for the complicated tasks."""
    task_request = TaskV2Request(**kwargs)
    return await Agent().observer_task_v_2(task_request=task_request)


@tool("get-skyvern-agent-task-v2", args_schema=GetTaskInput)
async def get_task_v_2(task_id: str) -> ObserverTask | None:
