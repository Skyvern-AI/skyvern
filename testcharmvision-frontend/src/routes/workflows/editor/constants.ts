...
export const TESTCHARMVISION_DOWNLOAD_DIRECTORY = "TESTCHARMVISION_DOWNLOAD_DIRECTORY";
...
export const SMTP_HOST_AWS_KEY = "TESTCHARMVISION_SMTP_HOST_AWS_SES";
export const SMTP_PORT_AWS_KEY = "TESTCHARMVISION_SMTP_PORT_AWS_SES";
export const SMTP_USERNAME_AWS_KEY = "TESTCHARMVISION_SMTP_USERNAME_SES";
export const SMTP_PASSWORD_AWS_KEY = "TESTCHARMVISION_SMTP_PASSWORD_SES";

export const EMAIL_BLOCK_SENDER = "hello@testcharmvision.com";

export const BITWARDEN_CLIENT_ID_AWS_SECRET_KEY = "TESTCHARMVISION_BITWARDEN_CLIENT_ID";
export const BITWARDEN_CLIENT_SECRET_AWS_SECRET_KEY =
  "TESTCHARMVISION_BITWARDEN_CLIENT_SECRET";
export const BITWARDEN_MASTER_PASSWORD_AWS_SECRET_KEY =
  "TESTCHARMVISION_BITWARDEN_MASTER_PASSWORD";
