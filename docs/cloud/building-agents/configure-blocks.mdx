...
Upload downloaded files to S3, Azure Blob Storage, or Google Drive.

| Field | Type | Description |
|-------|------|-------------|
| **Storage Type** | select | `Amazon S3`, `Azure Blob Storage`, or `Google Drive` |
...
<Accordion title="Google Drive fields">

| Field | Description |
|-------|-------------|
| **Google Credential** | A connected Google account credential authorized with the `google_drive` scope profile |
| **Google Drive Folder ID** | Destination folder ID in Google Drive (optional) |
