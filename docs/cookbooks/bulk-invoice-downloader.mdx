...
**Workflow definition** is a YAML or JSON format that describes this sequence of blocks and their individual configurations. We will first define the blocks in isolation, then show the full workflow definition schema.
...
<Accordion title="Complete workflow definition (YAML)">
```yaml
title: Bulk Invoice Downloader
description: ""
...
<Accordion title="Complete workflow definition (JSON)">
```json
{
  "title": "Bulk Invoice Downloader",
  "description": "",
...
async def main():
    ...
    run = await client.run_workflow(
        ...
        parameters={
            "portal_url": "https://your-vendor-portal.com/login",  # <-- replace this
            "start_date": "2025-01-01",  # <-- replace this
            "end_date": "2025-01-31",  # <-- replace this
