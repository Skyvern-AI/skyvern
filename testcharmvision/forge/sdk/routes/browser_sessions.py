...
from testcharmvision.schemas.browser_sessions import (
    CreateBrowserSessionRequest,
    ProcessBrowserSessionRecordingRequest,
    ProcessBrowserSessionRecordingResponse,
)
from testcharmvision.webeye.schemas import BrowserSessionResponse
...
async def get_browser_sessions_all(
    ...
    analytics.capture("testcharmvision-oss-agent-browser-sessions-get-all")
...
async def get_browser_session(
    ...
    analytics.capture("testcharmvision-oss-agent-browser-session-get")
...
async def get_browser_sessions(
    ...
    analytics.capture("testcharmvision-oss-agent-browser-sessions-get")
