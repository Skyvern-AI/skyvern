...
description: Build an agent that parses your resume, searches job portals, extracts listings, generates tailored answers with AI, and submits applications automatically.
  ...
  <Tab title="Cloud UI">
    <Steps>
      <Step title="Create the agent">
        ...
        <img src="/images/cookbooks/create-workflow.png" alt="Create a new agent from Skyvern Dashboard" />
      </Step>
    </Steps>
  </Tab>
  <Tab title="API / SDK">
...
<Tabs>
  ...
  <img src="/images/cookbooks/add-params.png" alt="Setting input parameters in an agent in Skyvern" />
  </Tab>
  <Tab title="API / SDK">
...
<Tabs>
  <Tab title="Cloud UI">
    ...
    <img src="/images/cookbooks/add-block.png" alt="Adding a block in an agent in Skyvern" />
  </Tab>
  <Tab title="API / SDK">
    <CodeGroup>
    ```json JSON
