...
description: Create multi-step browser automations in the Skyvern Cloud UI using the visual workflow editor with blocks for navigation, extraction, loops, conditionals, and email.
...
This page explains how workflows work, walks you through building one from scratch, and covers the editor's features.
