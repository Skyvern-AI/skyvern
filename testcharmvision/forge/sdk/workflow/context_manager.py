...
from testcharmvision.forge.sdk.api.azure import AsyncAzureVaultClient
from testcharmvision.forge.sdk.db.enums import OrganizationAuthTokenType
from testcharmvision.forge.sdk.schemas.credentials import CredentialVaultType, PasswordCredential
...
from testcharmvision.forge.sdk.services.bitwarden import BitwardenConstants, BitwardenService
from testcharmvision.forge.sdk.services.credentials import AzureVaultConstants, OnePasswordConstants, parse_totp_secret
from testcharmvision.forge.sdk.workflow.exceptions import OutputParameterKeyCollisionError
...
if TYPE_CHECKING:
    from testcharmvision.forge.sdk.workflow.models.workflow import Workflow, WorkflowRunParameter
...
class WorkflowRunContext:
    ...
    async def register_onepassword_credential_parameter_value(
        ...
        client = await OnePasswordClient.authenticate(
            auth=token,
            integration_name="Testcharmvision",
    ...
    async def register_bitwarden_login_credential_parameter_value(
        ...
        if not url and not parameter.bitwarden_item_id:
            ...
            raise TestcharmvisionException("URL parameter for Bitwarden login credentials not found or has no value")
