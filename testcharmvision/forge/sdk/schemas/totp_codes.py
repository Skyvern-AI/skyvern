...
class TOTPCodeBase(BaseModel):
    ...
    content: str | None = Field(
        default=None,
        description="The content of the TOTP code. It can be the email content that contains the TOTP code, or the sms message that contains the TOTP code. Testcharmvision will automatically extract the TOTP code from the content.",
...
class TOTPCode(TOTPCodeCreate):
    totp_code_id: str = Field(..., description="The testcharmvision ID of the TOTP code.")
