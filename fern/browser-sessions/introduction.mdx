...
- You have multiple continous tasks that need to interact with the browser in real-time without much delay. For example, you are developing a phone agent for your customer support center and your agent needs access to real time information in the browser.
...
Skyvern Browser Sessions is currently in Beta and is only available through [API & SDK](/api-reference/api-reference/browser-session/create-browser-session).
