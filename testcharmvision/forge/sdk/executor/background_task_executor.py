...
from testcharmvision.exceptions import OrganizationNotFound
...
from testcharmvision.services import script_service, task_v2_service
from testcharmvision.utils.files import initialize_testcharmvision_state_file
...
class BackgroundTaskExecutor(AsyncExecutor):
    async def execute_task(
        ...
        **kwargs: dict,
        ...
        context: TestcharmvisionContext = testcharmvision_context.ensure_context()
        ...
        if background_tasks:
            await initialize_testcharmvision_state_file(task_id=task_id, organization_id=organization_id)
    ...
    async def execute_workflow(
        ...
        **kwargs: dict,
        ...
        if background_tasks:
            ...
            await initialize_testcharmvision_state_file(
