...
class TestcharmvisionDefinedError(BaseModel):
    error_code: str
    reasoning: str
...
class ReachMaxStepsError(TestcharmvisionDefinedError):
    error_code: str = "REACH_MAX_STEPS"
    reasoning: str = "The agent has reached the maximum number of steps."


class ReachMaxRetriesError(TestcharmvisionDefinedError):
    error_code: str = "REACH_MAX_RETRIES"
    reasoning: str = "The agent has reached the maximum number of retries. It might be an issue with the agent. Please reach out to the Testcharmvision team for support."


class GetTOTPVerificationCodeError(TestcharmvisionDefinedError):
...
class TimeoutGetTOTPVerificationCodeError(TestcharmvisionDefinedError):
    error_code: str = "OTP_TIMEOUT"
    reasoning: str = "Timeout getting TOTP verification code."


class TOTPExpiredError(TestcharmvisionDefinedError):
