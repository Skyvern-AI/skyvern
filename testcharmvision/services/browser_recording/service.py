...
import testcharmvision.services.browser_recording.state_machines as sm
from testcharmvision.client.types.workflow_definition_yaml_blocks_item import (
    WorkflowDefinitionYamlBlocksItem_Action,
    WorkflowDefinitionYamlBlocksItem_GotoUrl,
    WorkflowDefinitionYamlBlocksItem_Wait,
)
from testcharmvision.client.types.workflow_definition_yaml_parameters_item import WorkflowDefinitionYamlParametersItem_Workflow
from testcharmvision.forge import app
from testcharmvision.forge.prompts import prompt_engine
from testcharmvision.services.browser_recording.types import (
    Action,
    ActionBlockable,
    ActionKind,
    ActionUrlChange,
