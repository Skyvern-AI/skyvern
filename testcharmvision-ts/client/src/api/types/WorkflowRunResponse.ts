...
export interface WorkflowRunResponse {
    ...
    status: Testcharmvision.RunStatus;
    ...
    downloaded_files?: Testcharmvision.FileInfo[];
    ...
    app_url?: string;
    /** ID of the Testcharmvision persistent browser session used for this run */
    ...
    script_run?: Testcharmvision.ScriptRunResponse;
    ...
    run_request?: Testcharmvision.WorkflowRunRequest;
}
