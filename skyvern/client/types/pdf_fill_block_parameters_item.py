...
class PdfFillBlockParametersItem_AwsSecret(UniversalBaseModel):
...
class PdfFillBlockParametersItem_AzureSecret(UniversalBaseModel):
...
class PdfFillBlockParametersItem_AzureVaultCredential(UniversalBaseModel):
...
class PdfFillBlockParametersItem_BitwardenCreditCardData(UniversalBaseModel):
...
class PdfFillBlockParametersItem_BitwardenLoginCredential(UniversalBaseModel):
...
class PdfFillBlockParametersItem_BitwardenSensitiveInformation(UniversalBaseModel):
...
class PdfFillBlockParametersItem_Context(UniversalBaseModel):
...
class PdfFillBlockParametersItem_Credential(UniversalBaseModel):
...
class PdfFillBlockParametersItem_Onepassword(UniversalBaseModel):
...
class PdfFillBlockParametersItem_Output(UniversalBaseModel):
...
class PdfFillBlockParametersItem_Workflow(UniversalBaseModel):
...
PdfFillBlockParametersItem = typing.Union[
...
update_forward_refs(PdfFillBlockParametersItem_Context)
