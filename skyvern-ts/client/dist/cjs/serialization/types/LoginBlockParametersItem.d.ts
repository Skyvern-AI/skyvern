...
export declare const LoginBlockParametersItem: core.serialization.Schema<serializers.LoginBlockParametersItem.Raw, Skyvern.LoginBlockParametersItem>;
export declare namespace LoginBlockParametersItem {
    type Raw = LoginBlockParametersItem.AwsSecret | LoginBlockParametersItem.AzureSecret | LoginBlockParametersItem.AzureVaultCredential | LoginBlockParametersItem.BitwardenCreditCardData | LoginBlockParametersItem.BitwardenLoginCredential | LoginBlockParametersItem.BitwardenSensitiveInformation | LoginBlockParametersItem.Context | LoginBlockParametersItem.Credential | LoginBlockParametersItem.Onepassword | LoginBlockParametersItem.Output | LoginBlockParametersItem.Workflow;
