...
export declare const WorkflowDefinitionParametersItem: core.serialization.Schema<serializers.WorkflowDefinitionParametersItem.Raw, Skyvern.WorkflowDefinitionParametersItem>;
export declare namespace WorkflowDefinitionParametersItem {
    type Raw = WorkflowDefinitionParametersItem.AwsSecret | WorkflowDefinitionParametersItem.AzureSecret | WorkflowDefinitionParametersItem.AzureVaultCredential | WorkflowDefinitionParametersItem.BitwardenCreditCardData | WorkflowDefinitionParametersItem.BitwardenLoginCredential | WorkflowDefinitionParametersItem.BitwardenSensitiveInformation | WorkflowDefinitionParametersItem.Context | WorkflowDefinitionParametersItem.Credential | WorkflowDefinitionParametersItem.Onepassword | WorkflowDefinitionParametersItem.Output | WorkflowDefinitionParametersItem.Workflow;
