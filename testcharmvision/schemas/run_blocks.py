...
class LoginRequest(BaseRunBlockRequest):
    ...
    prompt: str | None = Field(
        default=None,
        description="Login instructions. Testcharmvision has default prompt/instruction for login if this field is not provided.",
    )

    # Testcharmvision credential
    credential_id: str | None = Field(
        default=None, description="ID of the Testcharmvision credential to use for login.", examples=["cred_123"]
    )
