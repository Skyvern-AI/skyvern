...
export type LoginBlockParametersItem =
    | Skyvern.LoginBlockParametersItem.AwsSecret
    | Skyvern.LoginBlockParametersItem.AzureSecret
    | Skyvern.LoginBlockParametersItem.AzureVaultCredential
    | Skyvern.LoginBlockParametersItem.BitwardenCreditCardData
    | Skyvern.LoginBlockParametersItem.BitwardenLoginCredential
    | Skyvern.LoginBlockParametersItem.BitwardenSensitiveInformation
    | Skyvern.LoginBlockParametersItem.Context
    | Skyvern.LoginBlockParametersItem.Credential
    | Skyvern.LoginBlockParametersItem.Onepassword
    | Skyvern.LoginBlockParametersItem.Output
    | Skyvern.LoginBlockParametersItem.Workflow;
