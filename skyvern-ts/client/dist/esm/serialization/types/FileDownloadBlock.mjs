...
export const FileDownloadBlock = core.serialization.object({
    ...
    dataSchema: core.serialization.property("data_schema", FileDownloadBlockDataSchema.optional()),
    ...
    parameters: core.serialization.list(FileDownloadBlockParametersItem).optional(),
