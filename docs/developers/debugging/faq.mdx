...
The AI will automatically fetch and enter the TOTP code when it encounters a 2FA prompt. See [2FA / TOTP Setup](/cloud/managing-credentials/totp-setup) for detailed instructions.
</Accordion>
