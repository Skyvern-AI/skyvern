...
<div className="sk-bento-row sk-bento-3col">
  <div className="sk-bento-cell">
    ...
    <div className="sk-cell-links">
      ...
      <a href="/docs/cloud/building-agents/build-an-agent" className="sk-cell-link">Build an agent <span className="sk-arrow">↗</span></a>
...
<div className="sk-bento-row sk-bento-4col">
  <a href="/docs/cloud/building-agents/build-an-agent" className="sk-bento-cell sk-bento-cell-link sk-bento-cell-sm sk-usecase-orange">
    <span className="sk-usecase-icon">
  ...
  <a href="/docs/cloud/building-agents/configure-blocks" className="sk-bento-cell sk-bento-cell-link sk-bento-cell-sm sk-usecase-orange">
    <span className="sk-usecase-icon">
