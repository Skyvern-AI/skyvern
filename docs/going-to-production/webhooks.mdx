...
The SDK method is fire-and-forget—it returns immediately without waiting for confirmation. To verify the retry succeeded, check the `failure_reason` field on the run afterward, or monitor your webhook endpoint directly.
