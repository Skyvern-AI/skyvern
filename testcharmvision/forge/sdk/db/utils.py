...
from testcharmvision.forge.sdk.schemas.workflow_copilot import WorkflowCopilotChatMessage as WorkflowCopilotChatMessageSchema
...
from testcharmvision.schemas.runs import GeoTarget, ProxyLocation, ProxyLocationInput, ScriptRunResponse
from testcharmvision.schemas.scripts import Script, ScriptBlock, ScriptFile
from testcharmvision.schemas.workflows import BlockStatus, BlockType
...
def hydrate_action(action_model: ActionModel, empty_element_id: bool = False) -> Action:
    ...
    action_data = {
        ...
        "testcharmvision_element_hash": action_model.testcharmvision_element_hash,
        "testcharmvision_element_data": action_model.testcharmvision_element_data,
