...
{/* <img src="/images/cloud/browsers-page-overview.png" alt="Browsers page showing a table of active browser sessions" /> */}
...
{/* <img src="/images/cloud/create-session-drawer.png" alt="Create Browser Session panel with configuration options" /> */}
...
A live view of the browser. You can watch pages load and actions fire in real time. If you need to interact with the browser yourself — log in, dismiss a popup, solve a CAPTCHA — use the controls to take over.

{/* <img src="/images/cloud/session-stream-tab.png" alt="Live browser stream showing a website" /> */}
...
{/* <img src="/images/cloud/session-id-in-discover.png" alt="Advanced settings on the Discover page with Browser Session ID filled in" /> */}
