...
What this channel looks like:
    ...
    [Testcharmvision App] <-- [API Server] <--> [Browser (CDP)]
...
from testcharmvision.forge.sdk.routes.streaming.channels.cdp import CdpChannel
from testcharmvision.forge.sdk.routes.streaming.channels.vnc import VncChannel
