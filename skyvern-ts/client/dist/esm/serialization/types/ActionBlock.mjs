...
export const ActionBlock = core.serialization.object({
    ...
    dataSchema: core.serialization.property("data_schema", ActionBlockDataSchema.optional()),
    ...
    parameters: core.serialization.list(ActionBlockParametersItem).optional(),
