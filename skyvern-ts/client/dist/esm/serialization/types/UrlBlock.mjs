...
export const UrlBlock = core.serialization.object({
    ...
    dataSchema: core.serialization.property("data_schema", UrlBlockDataSchema.optional()),
    ...
    parameters: core.serialization.list(UrlBlockParametersItem).optional(),
