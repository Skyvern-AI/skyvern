...
from testcharmvision.exceptions import MissingBrowserAddressError
...
from testcharmvision.forge.sdk.routes.code_samples import (
    ...
    LOGIN_CODE_SAMPLE_TESTCHARMVISION_PYTHON,
    LOGIN_CODE_SAMPLE_TESTCHARMVISION_TS,
)
from testcharmvision.forge.sdk.routes.routers import base_router
...
from testcharmvision.forge.sdk.workflow.models.parameter import WorkflowParameterType
from testcharmvision.forge.sdk.workflow.models.workflow import Workflow, WorkflowRequestBody
from testcharmvision.schemas.run_blocks import BaseRunBlockRequest, CredentialType, DownloadFilesRequest, LoginRequest
from testcharmvision.schemas.runs import ProxyLocation, RunType, WorkflowRunRequest, WorkflowRunResponse
...
from testcharmvision.services import workflow_service
...
@base_router.post(
    ...
    openapi_extra={
        ...
        "x-fern-examples": [
            {
                "code-samples": [
                    {"sdk": "python", "code": LOGIN_CODE_SAMPLE_TESTCHARMVISION_PYTHON},
                    {"sdk": "python", "code": LOGIN_CODE_SAMPLE_BITWARDEN_PYTHON},
                    {"sdk": "python", "code": LOGIN_CODE_SAMPLE_ONEPASSWORD_PYTHON},
                    {"sdk": "typescript", "code": LOGIN_CODE_SAMPLE_TESTCHARMVISION_TS},
    ...
    description="Log in to a website using either credential stored in Testcharmvision, Bitwarden, 1Password, or Azure Vault",
    summary="Login Task",
)
async def login(
    request: Request,
    ...
    if login_request.credential_type == CredentialType.testcharmvision:
        if not login_request.credential_id:
            raise HTTPException(status_code=400, detail="credential_id is required to login with Testcharmvision credential")
        ...
        yaml_parameters = [
            BitwardenLoginCredentialParameterYAML(
                ...
                bitwarden_client_id_aws_secret_key="TESTCHARMVISION_BITWARDEN_CLIENT_ID",
                bitwarden_client_secret_aws_secret_key="TESTCHARMVISION_BITWARDEN_CLIENT_SECRET",
                bitwarden_master_password_aws_secret_key="TESTCHARMVISION_BITWARDEN_MASTER_PASSWORD",
            )
        ]
