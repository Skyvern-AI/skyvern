...
from testcharmvision.forge.sdk.schemas.totp_codes import OTPType, TOTPCode, TOTPCodeCreate
from testcharmvision.forge.sdk.services import org_auth_service
from testcharmvision.forge.sdk.services.bitwarden import BitwardenService
from testcharmvision.forge.sdk.services.credential.credential_vault_service import CredentialVaultService
from testcharmvision.services.otp_service import OTPValue, parse_otp_login
...
@base_router.post(
    ...
    description="Forward a TOTP (2FA, MFA) email or sms message containing the code to Testcharmvision. This endpoint stores the code in database so that Testcharmvision can use it while running tasks/workflows.",
    tags=["Credentials"],
    openapi_extra={
