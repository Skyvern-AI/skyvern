...
| **Skyvern Web UI** | Browser-based dashboard for building agents, running tasks, viewing recordings, and managing credentials. Docker Compose starts it alongside the API server. |
