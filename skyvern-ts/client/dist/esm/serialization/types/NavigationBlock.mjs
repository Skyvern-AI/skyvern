...
import { NavigationBlockDataSchema } from "./NavigationBlockDataSchema.mjs";
import { NavigationBlockParametersItem } from "./NavigationBlockParametersItem.mjs";
import { OutputParameter } from "./OutputParameter.mjs";
import { RunEngine } from "./RunEngine.mjs";
export const NavigationBlock = core.serialization.object({
    ...
    dataSchema: core.serialization.property("data_schema", NavigationBlockDataSchema.optional()),
    ...
    parameters: core.serialization.list(NavigationBlockParametersItem).optional(),
