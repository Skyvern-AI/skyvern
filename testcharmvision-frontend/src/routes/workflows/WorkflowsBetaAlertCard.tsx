...
function WorkflowsBetaAlertCard() {
  return (
    <div className="flex flex-col items-center rounded-lg bg-slate-900 p-4 shadow">
      ...
      <div>
        Today, you can create and run workflows through the Testcharmvision API.
      </div>
      <div className="flex gap-4 py-4">
        <Button variant="secondary" asChild>
          <a
            href="https://www.testcharmvision.com/docs/workflows/creating-workflows"
            target="_blank"
        ...
        <Button asChild>
          <a
            href="https://meetings.hubspot.com/testcharmvision/demo"
            target="_blank"
            rel="noopener noreferrer"
          >
            Book a demo
