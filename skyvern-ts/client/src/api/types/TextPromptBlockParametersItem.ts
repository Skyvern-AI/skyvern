...
export type TextPromptBlockParametersItem =
    | Skyvern.TextPromptBlockParametersItem.AwsSecret
    | Skyvern.TextPromptBlockParametersItem.AzureSecret
    | Skyvern.TextPromptBlockParametersItem.AzureVaultCredential
    | Skyvern.TextPromptBlockParametersItem.BitwardenCreditCardData
    | Skyvern.TextPromptBlockParametersItem.BitwardenLoginCredential
    | Skyvern.TextPromptBlockParametersItem.BitwardenSensitiveInformation
    | Skyvern.TextPromptBlockParametersItem.Context
    | Skyvern.TextPromptBlockParametersItem.Credential
    | Skyvern.TextPromptBlockParametersItem.Onepassword
    | Skyvern.TextPromptBlockParametersItem.Output
    | Skyvern.TextPromptBlockParametersItem.Workflow;
