...
Skyvern can integrate with your 1password Vault. Skyvern agent can read the credentials on the fly to complete tasks while keeping your credentials secure. Skyvern never stores your credentials or sends them to LLMs.
...
### 1password Integration for Self Hosted Skyvern
**Step 1. Create a new vault**
Assume you have a 1password account already - sign in and go to the [home page](https://my.1password.com/home). Create a new vault in 1password.
