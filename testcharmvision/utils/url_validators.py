...
from testcharmvision.exceptions import BlockedHost, InvalidUrl, TestcharmvisionHTTPException
...
def validate_url(url: str) -> str | None:
    try:
        ...
        raise TestcharmvisionHTTPException(message=str(e), status_code=status.HTTP_400_BAD_REQUEST)
