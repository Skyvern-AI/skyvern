...
export const TaskRunResponse = core.serialization.object({
    runId: core.serialization.property("run_id", core.serialization.string()),
    status: RunStatus,
    output: TaskRunResponseOutput.optional(),
    ...
    errors: core.serialization
        ...
        .optional(),
    runRequest: core.serialization.property("run_request", TaskRunRequest.optional()),
});
