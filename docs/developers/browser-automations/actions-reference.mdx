...
If you're building automations visually instead, see [Block Types and Configuration](/cloud/building-agents/configure-blocks) for the equivalent operations in the Cloud UI agent editor.
