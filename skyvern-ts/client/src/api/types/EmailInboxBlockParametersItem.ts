...
export type EmailInboxBlockParametersItem =
    | Skyvern.EmailInboxBlockParametersItem.AwsSecret
    | Skyvern.EmailInboxBlockParametersItem.AzureSecret
    | Skyvern.EmailInboxBlockParametersItem.AzureVaultCredential
    | Skyvern.EmailInboxBlockParametersItem.BitwardenCreditCardData
    | Skyvern.EmailInboxBlockParametersItem.BitwardenLoginCredential
    | Skyvern.EmailInboxBlockParametersItem.BitwardenSensitiveInformation
    | Skyvern.EmailInboxBlockParametersItem.Context
    | Skyvern.EmailInboxBlockParametersItem.Credential
    | Skyvern.EmailInboxBlockParametersItem.Onepassword
    | Skyvern.EmailInboxBlockParametersItem.Output
    | Skyvern.EmailInboxBlockParametersItem.Workflow;

export namespace EmailInboxBlockParametersItem {
