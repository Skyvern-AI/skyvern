...
from typing import Annotated, Any, Callable, ClassVar, Literal, Union, cast
...
# Late import: these sibling modules import Block from this module, so a top-level import would cycle.
# block.py stays the import facade — every name below is re-exported for zero call-site changes.
