...
export declare const ForLoopBlockLoopOver: core.serialization.Schema<serializers.ForLoopBlockLoopOver.Raw, Skyvern.ForLoopBlockLoopOver>;
export declare namespace ForLoopBlockLoopOver {
    type Raw = ForLoopBlockLoopOver.AwsSecret | ForLoopBlockLoopOver.AzureSecret | ForLoopBlockLoopOver.AzureVaultCredential | ForLoopBlockLoopOver.BitwardenCreditCardData | ForLoopBlockLoopOver.BitwardenLoginCredential | ForLoopBlockLoopOver.BitwardenSensitiveInformation | ForLoopBlockLoopOver.Context | ForLoopBlockLoopOver.Credential | ForLoopBlockLoopOver.Onepassword | ForLoopBlockLoopOver.Output | ForLoopBlockLoopOver.Workflow;
