...
export declare const WaitBlockParametersItem: core.serialization.Schema<serializers.WaitBlockParametersItem.Raw, Skyvern.WaitBlockParametersItem>;
export declare namespace WaitBlockParametersItem {
    type Raw = WaitBlockParametersItem.AwsSecret | WaitBlockParametersItem.AzureSecret | WaitBlockParametersItem.AzureVaultCredential | WaitBlockParametersItem.BitwardenCreditCardData | WaitBlockParametersItem.BitwardenLoginCredential | WaitBlockParametersItem.BitwardenSensitiveInformation | WaitBlockParametersItem.Context | WaitBlockParametersItem.Credential | WaitBlockParametersItem.Onepassword | WaitBlockParametersItem.Output | WaitBlockParametersItem.Workflow;
