...
async def run_task(
    ...
    # Parameters are now handled by the workflow parameter system
    # No special processing needed here - parameters are stored with the task
...
# Legacy TaskCredentialHandler - will be removed when workflow parameter system is fully integrated
...
#     
#     async def process_credentials(self, credentials) -> dict[str, dict[str, str]]:
