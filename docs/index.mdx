...
description: Skyvern is an AI-powered browser automation platform. Describe tasks in plain English and Skyvern opens a real browser, reads the page visually, and completes the task using tasks, agents, and the API or SDK.
slug: /
mode: custom
---

{/* Keep the links on this page absolute. mint broken-links cannot resolve /docs/... paths, and raw <a> tags on this custom-mode page may render without the /docs base path. */}
  ...
  <div className="sk-hero-inner">
    <div className="sk-hero-left">
      <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
        ...
        <a href="https://www.skyvern.com/docs/changelog" className="sk-version-badge">v1.0.22 (latest)</a>
      </div>
      ...
      <div className="sk-hero-actions">
        <a href="https://www.skyvern.com/docs/developers/getting-started/quickstart" className="sk-btn-primary">Get started with the API →</a>
        <a href="https://www.skyvern.com/docs/cloud/getting-started/overview" className="sk-btn-secondary">Use the dashboard</a>
      </div>
    </div>
...
<div className="sk-bento-row sk-bento-3col">
  <div className="sk-bento-cell">
    ...
    <p className="sk-cell-desc">Use the dashboard to run tasks and build agents visually.</p>
    <div className="sk-cell-links">
      <a href="https://www.skyvern.com/docs/cloud/getting-started/overview" className="sk-cell-link">Dashboard overview <span className="sk-arrow">↗</span></a>
      <a href="https://www.skyvern.com/docs/cloud/getting-started/run-your-first-task" className="sk-cell-link">Run your first task <span className="sk-arrow">↗</span></a>
      <a href="https://www.skyvern.com/docs/cloud/building-agents/build-an-agent" className="sk-cell-link">Build an agent <span className="sk-arrow">↗</span></a>
      <a href="https://www.skyvern.com/docs/integrations/zapier" className="sk-cell-link">Connect to Zapier <span className="sk-arrow">↗</span></a>
    </div>
  </div>
  <div className="sk-bento-cell">
    ...
    <div className="sk-cell-links">
      <a href="https://www.skyvern.com/docs/developers/getting-started/quickstart" className="sk-cell-link">API quickstart <span className="sk-arrow">↗</span></a>
      <a href="https://www.skyvern.com/docs/sdk-reference/overview" className="sk-cell-link">SDK reference <span className="sk-arrow">↗</span></a>
      <a href="https://www.skyvern.com/docs/api-reference" className="sk-cell-link">API reference <span className="sk-arrow">↗</span></a>
    </div>
  </div>
  <div className="sk-bento-cell">
    ...
    <div className="sk-cell-links">
      <a href="https://www.skyvern.com/docs/developers/self-hosted/overview" className="sk-cell-link">Deployment overview <span className="sk-arrow">↗</span></a>
      <a href="https://www.skyvern.com/docs/developers/self-hosted/docker" className="sk-cell-link">Docker setup <span className="sk-arrow">↗</span></a>
      <a href="https://www.skyvern.com/docs/developers/self-hosted/llm-configuration" className="sk-cell-link">LLM configuration <span className="sk-arrow">↗</span></a>
      <a href="https://www.skyvern.com/docs/developers/self-hosted/kubernetes" className="sk-cell-link">Kubernetes <span className="sk-arrow">↗</span></a>
    </div>
  </div>
</div>
...
<div className="sk-bento-row sk-bento-2col">
  <a href="https://www.skyvern.com/docs/developers/getting-started/introduction" className="sk-bento-cell sk-bento-cell-link">
  ...
  <a href="https://www.skyvern.com/docs/developers/getting-started/core-concepts" className="sk-bento-cell sk-bento-cell-link">
    <p className="sk-mono sk-label">REFERENCE</p>
    <h3 className="sk-cell-title">Core concepts</h3>
    <p className="sk-cell-desc">Tasks, agents, blocks, runs, credentials, browser sessions, and engines.</p>
    <span className="sk-mono sk-arrow-lg">↗</span>
  </a>
</div>
...
<div className="sk-bento-row sk-bento-4col">
  <a href="https://www.skyvern.com/docs/cookbooks/bulk-invoice-downloader" className="sk-bento-cell sk-bento-cell-link sk-bento-cell-sm sk-usecase-teal">
  ...
  <a href="https://www.skyvern.com/docs/cookbooks/job-application-filler" className="sk-bento-cell sk-bento-cell-link sk-bento-cell-sm sk-usecase-orange">
    <span className="sk-usecase-icon">
  ...
  <a href="https://www.skyvern.com/docs/developers/browser-automations/extract-structured-data" className="sk-bento-cell sk-bento-cell-link sk-bento-cell-sm sk-usecase-teal">
    <span className="sk-usecase-icon">
  ...
  <a href="https://www.skyvern.com/docs/cookbooks/healthcare-portal-data" className="sk-bento-cell sk-bento-cell-link sk-bento-cell-sm sk-usecase-orange">
    <span className="sk-usecase-icon">
...
<div className="sk-bento-row sk-bento-4col">
  <a href="https://www.skyvern.com/docs/cloud/building-agents/build-an-agent" className="sk-bento-cell sk-bento-cell-link sk-bento-cell-sm sk-usecase-orange">
    <span className="sk-usecase-icon">
  ...
  <a href="https://www.skyvern.com/docs/cloud/getting-started/run-from-code" className="sk-bento-cell sk-bento-cell-link sk-bento-cell-sm sk-usecase-teal">
    <span className="sk-usecase-icon">
  ...
  <a href="https://www.skyvern.com/docs/cloud/building-agents/configure-blocks" className="sk-bento-cell sk-bento-cell-link sk-bento-cell-sm sk-usecase-orange">
    <span className="sk-usecase-icon">
  ...
  <a href="https://www.skyvern.com/docs/cookbooks/job-application-filler" className="sk-bento-cell sk-bento-cell-link sk-bento-cell-sm sk-usecase-teal">
    <span className="sk-usecase-icon">
